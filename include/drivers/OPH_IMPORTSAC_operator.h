...
#ifndef __OPH_IMPORTSAC_OPERATOR_H
#define __OPH_IMPORTSAC_OPERATOR_H
...
#define OPH_IMPORTSAC_SUBSET_INDEX	    "index" 
#define OPH_IMPORTSAC_SUBSET_COORD	    "coord"
#define OPH_IMPORTSAC_DIMENSION_DEFAULT	"auto"

//Only import of measured variables is supported

/**
 * \brief Structure of parameters needed by the operator OPH_IMPORTSAC. It creates a new datacube filling it with data taken from nc file
 *
 ...
 */
struct _OPH_IMPORTSAC_operator_handle
{
  ophidiadb oDB;
...
/* For sac files variables related to time management could be unuseful */
  char* base_time;
  char* units;
  char* calendar;
  char* month_lengths;
...
typedef struct _OPH_IMPORTSAC_operator_handle OPH_IMPORTSAC_operator_handle;

#endif  //__OPH_IMPORTSAC_OPERATOR_H
