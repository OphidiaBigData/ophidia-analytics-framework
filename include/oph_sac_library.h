 ...
 * \return 0 if successfull
 */
int oph_sac_populate_fragment_from_sac3(oph_ioserver_handler * server, oph_odb_fragment * frag, FILE * fptr, int tuplexfrag_number, int array_length, int compressed, SAC_var * measure,
