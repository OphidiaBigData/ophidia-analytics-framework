...
#define OPH_DC_SQ_COUNT_ROWS_FRAG OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_OPERATION, OPH_IOSERVER_SQ_OP_SELECT) OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_ARG_FIELD, "oph_convert_l('OPH_LONG','',oph_aggregate_operator('OPH_LONG','OPH_LONG', oph_get_subarray('OPH_%s','OPH_LONG', measure, 1, 1),'OPH_COUNT'))") OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_ARG_FROM, "%s") 
