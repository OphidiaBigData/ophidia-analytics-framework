...
#define MYSQL_QUERY_DIM_UPDATE_OPHIDIADB_DIMENSION_INST			"INSERT INTO `dimensioninstance` (`iddimension`, `size`, `fkiddimensionindex`, `idgrid`, `conceptlevel`, `unlimited`, `fkiddimensionlabel`) VALUES (%d, %d, %d, %d, '%c', '%c', %d);"

#define MYSQL_QUERY_DIM_UPDATE_OPHIDIADB_DIMENSION_INST_2		"INSERT INTO `dimensioninstance` (`iddimension`, `size`, `fkiddimensionindex`, `conceptlevel`, `unlimited`, `fkiddimensionlabel`) VALUES (%d, %d, %d, '%c', '%c', %d);"
