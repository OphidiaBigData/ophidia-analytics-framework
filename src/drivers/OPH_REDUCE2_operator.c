	...
	if (global_error) {
		...
		int num_threads =
		    (((OPH_REDUCE2_operator_handle *) handle->operator_handle)->nthread <=
		     (unsigned int) ((OPH_REDUCE2_operator_handle *) handle->operator_handle)->fragment_number ? ((OPH_REDUCE2_operator_handle *) handle->operator_handle)->
		     nthread : (unsigned int) ((OPH_REDUCE2_operator_handle *) handle->operator_handle)->fragment_number);
