...
*/
					...
					if(oph_dc_read_fragment_data(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->server, &(frags.value[k]), data_type, compressed, NULL, NULL, NULL, 0, 1,&frag_rows))
					{
