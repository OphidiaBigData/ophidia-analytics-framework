...
#ifndef __OPH_EXPORTFITS_OPERATOR_H
#define __OPH_EXPORTFITS_OPERATOR_H
...
#define OPH_EXPORTFITS_OUTPUT_FILE "%s_%d.fits"
#define OPH_EXPORTFITS_OUTPUT_PATH "%s/"
#define OPH_EXPORTFITS_OUTPUT_PATH_SUMMARY OPH_EXPORTFITS_OUTPUT_PATH"%s.html"
#define OPH_EXPORTFITS_OUTPUT_PATH_SINGLE_FILE OPH_EXPORTFITS_OUTPUT_PATH"%s.fits"
#define OPH_EXPORTFITS_OUTPUT_PATH_MORE_FILES OPH_EXPORTFITS_OUTPUT_PATH""OPH_EXPORTFITS_OUTPUT_FILE

/**
 * \brief Structure of parameters needed by the operator OPH_EXPORTFITS. It export as fits files a datacube_input
 ...
 */
struct _OPH_EXPORTFITS_operator_handle
{
  ophidiadb oDB;
  char *datacube_input;
  ...
  int force;
  int misc;
  char *fits_templ_path;
};
typedef struct _OPH_EXPORTFITS_operator_handle OPH_EXPORTFITS_operator_handle;

#endif  //__OPH_EXPORTFITS_OPERATOR_H
