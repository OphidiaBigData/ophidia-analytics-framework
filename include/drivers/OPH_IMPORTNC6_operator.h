...
#ifndef __OPH_IMPORTNC6_OPERATOR_H
#define __OPH_IMPORTNC6_OPERATOR_H
...
#define OPH_IMPORTNC6_SUBSET_INDEX	    "index"
#define OPH_IMPORTNC6_SUBSET_COORD	    "coord"
#define OPH_IMPORTNC6_DIMENSION_DEFAULT	"auto"

//Only import of measured variables is supported

/**
 * \brief Structure of parameters needed by the operator OPH_IMPORTNC6. It creates a new datacube filling it with data taken from nc file
 *
 ...
 */
struct _OPH_IMPORTNC6_operator_handle {
	ophidiadb oDB;
...
typedef struct _OPH_IMPORTNC6_operator_handle OPH_IMPORTNC6_operator_handle;

#endif				//__OPH_IMPORTNC6_OPERATOR_H
