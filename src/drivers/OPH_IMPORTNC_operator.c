...
int env_set(HASHTBL * task_tbl, oph_operator_struct * handle)
{
	...
	((OPH_IMPORTNC_operator_handle *) handle->operator_handle)->output_path = NULL;
	...
	if (!strstr(((OPH_IMPORTNC_operator_handle *) handle->operator_handle)->nc_file_path, "http://")
	    ...
	    && !strstr(((OPH_IMPORTNC_operator_handle *) handle->operator_handle)->nc_file_path, "esdm://")) {
...
int env_unset(oph_operator_struct * handle)
{
	...
	if (((OPH_IMPORTNC_operator_handle *) handle->operator_handle)->output_path) {
		free((char *) ((OPH_IMPORTNC_operator_handle *) handle->operator_handle)->output_path);
		((OPH_IMPORTNC_operator_handle *) handle->operator_handle)->output_path = NULL;
	}
