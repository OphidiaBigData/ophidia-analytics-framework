...
#define OPH_DC_SQ_MULTI_INSERT_FRAG OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_OPERATION, OPH_IOSERVER_SQ_OP_MULTI_INSERT) OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_ARG_FRAG, "%s") OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_ARG_FIELD, "id_dim|measure") OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_ARG_VALUE, "")
...
#define OPH_DC_SQ_READ_RAW_FRAG OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_OPERATION, OPH_IOSERVER_SQ_OP_SELECT) OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_ARG_FIELD, "id_dim|measure") OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_ARG_FROM, "%s") OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_ARG_ORDER, "id_dim") 
...
#define OPH_DC_SQ_COUNT_ELEMENTS_FRAG OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_OPERATION, OPH_IOSERVER_SQ_OP_SELECT) OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_ARG_FIELD, "oph_convert_l('OPH_LONG', 'OPH_LONG', oph_aggregate_operator('OPH_LONG', 'OPH_LONG', oph_value_to_bin('OPH_LONG', 'OPH_LONG', oph_count_array('OPH_%s', 'OPH_%s', measure)), 'OPH_SUM'))") OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_ARG_FROM, "%s") 

#define OPH_DC_SQ_COUNT_COMPRESSED_ELEMENTS_FRAG OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_OPERATION, OPH_IOSERVER_SQ_OP_SELECT) OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_ARG_FIELD, "oph_convert_l('OPH_LONG', 'OPH_LONG', oph_aggregate_operator('OPH_LONG', 'OPH_LONG', oph_value_to_bin('OPH_LONG', 'OPH_LONG', oph_count_array( 'OPH_%s',  'OPH_%s', oph_uncompress('','',measure))), 'OPH_SUM'))") OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_ARG_FROM, "%s") 
...
#define OPH_DC_SQ_COUNT_BIT_ELEMENTS_FRAG OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_OPERATION, OPH_IOSERVER_SQ_OP_SELECT) OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_ARG_FIELD, "oph_convert_l('OPH_LONG', 'OPH_LONG', oph_aggregate_operator('OPH_LONG', 'OPH_LONG', oph_value_to_bin('OPH_LONG', 'OPH_LONG', oph_bit_size('', '', measure)), 'OPH_SUM'))") OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_ARG_FROM, "%s") 

#define OPH_DC_SQ_COUNT_COMPRESSED_BIT_ELEMENTS_FRAG OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_OPERATION, OPH_IOSERVER_SQ_OP_SELECT) OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_ARG_FIELD, "oph_convert_l('OPH_LONG', 'OPH_LONG', oph_aggregate_operator('OPH_LONG', 'OPH_LONG', oph_value_to_bin('OPH_LONG', 'OPH_LONG', oph_bit_size('', '', oph_uncompress('','',measure))), 'OPH_SUM'))") OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_ARG_FROM, "%s") 
...
#define OPH_DC_SQ_SIZE_ELEMENTS_FRAG OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_OPERATION, OPH_IOSERVER_SQ_OP_SELECT) OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_ARG_FIELD, OPH_IOSERVER_SQ_KW_TABLE_SIZE) OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_ARG_FIELD_ALIAS, "size") OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_ARG_FROM, OPH_IOSERVER_SQ_KW_INFO_SYSTEM) OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_ARG_WHERE, OPH_IOSERVER_SQ_KW_INFO_SYSTEM_TABLE" IN (%s) ")  
...
#define OPH_DC_SQ_COUNT_ROWS_FRAG OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_OPERATION, OPH_IOSERVER_SQ_OP_SELECT) OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_ARG_FIELD, "COUNT(*)") OPH_IOSERVER_SQ_BLOCK(OPH_IOSERVER_SQ_ARG_FROM, "%s") 
