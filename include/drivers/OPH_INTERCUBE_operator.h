...
#define OPH_INTERCUBE_QUERY2_COMPR_MYSQL_SUM "CREATE TABLE %s (%s integer, %s longblob) ENGINE=MyISAM DEFAULT CHARSET=latin1 AS SELECT %s.%s AS %s, oph_compress(oph_sum_array(oph_uncompress(%s.%s),oph_uncompress(%s.%s),'oph_%s','oph_%s')) AS %s FROM %s.%s, %s.%s WHERE %s.%s = %s.%s"
#define OPH_INTERCUBE_QUERY2_MYSQL_SUM "CREATE TABLE %s (%s integer, %s longblob) ENGINE=MyISAM DEFAULT CHARSET=latin1 AS SELECT %s.%s AS %s, oph_sum_array(%s.%s,%s.%s,'oph_%s','oph_%s') AS %s FROM %s.%s, %s.%s WHERE %s.%s = %s.%s"

#define OPH_INTERCUBE_QUERY2_COMPR_MYSQL_SUB "CREATE TABLE %s (%s integer, %s longblob) ENGINE=MyISAM DEFAULT CHARSET=latin1 AS SELECT %s.%s AS %s, oph_compress(oph_sub_array(oph_uncompress(%s.%s),oph_uncompress(%s.%s),'oph_%s','oph_%s')) AS %s FROM %s.%s, %s.%s WHERE %s.%s = %s.%s"
#define OPH_INTERCUBE_QUERY2_MYSQL_SUB "CREATE TABLE %s (%s integer, %s longblob) ENGINE=MyISAM DEFAULT CHARSET=latin1 AS SELECT %s.%s AS %s, oph_sub_array(%s.%s,%s.%s,'oph_%s','oph_%s') AS %s FROM %s.%s, %s.%s WHERE %s.%s = %s.%s"

#define OPH_INTERCUBE_QUERY2_COMPR_MYSQL_MUL "CREATE TABLE %s (%s integer, %s longblob) ENGINE=MyISAM DEFAULT CHARSET=latin1 AS SELECT %s.%s AS %s, oph_compress(oph_mul_array(oph_uncompress(%s.%s),oph_uncompress(%s.%s),'oph_%s','oph_%s')) AS %s FROM %s.%s, %s.%s WHERE %s.%s = %s.%s"
#define OPH_INTERCUBE_QUERY2_MYSQL_MUL "CREATE TABLE %s (%s integer, %s longblob) ENGINE=MyISAM DEFAULT CHARSET=latin1 AS SELECT %s.%s AS %s, oph_mul_array(%s.%s,%s.%s,'oph_%s','oph_%s') AS %s FROM %s.%s, %s.%s WHERE %s.%s = %s.%s"

#define OPH_INTERCUBE_QUERY2_COMPR_MYSQL_DIV "CREATE TABLE %s (%s integer, %s longblob) ENGINE=MyISAM DEFAULT CHARSET=latin1 AS SELECT %s.%s AS %s, oph_compress(oph_div_array(oph_uncompress(%s.%s),oph_uncompress(%s.%s),'oph_%s','oph_%s')) AS %s FROM %s.%s, %s.%s WHERE %s.%s = %s.%s"
#define OPH_INTERCUBE_QUERY2_MYSQL_DIV "CREATE TABLE %s (%s integer, %s longblob) ENGINE=MyISAM DEFAULT CHARSET=latin1 AS SELECT %s.%s AS %s, oph_div_array(%s.%s,%s.%s,'oph_%s','oph_%s') AS %s FROM %s.%s, %s.%s WHERE %s.%s = %s.%s"

#define OPH_INTERCUBE_QUERY2_COMPR_MYSQL_ABS "CREATE TABLE %s (%s integer, %s longblob) ENGINE=MyISAM DEFAULT CHARSET=latin1 AS SELECT %s.%s AS %s, oph_compress(oph_abs_array(oph_uncompress(%s.%s),oph_uncompress(%s.%s),'oph_%s','oph_%s')) AS %s FROM %s.%s, %s.%s WHERE %s.%s = %s.%s"
#define OPH_INTERCUBE_QUERY2_MYSQL_ABS "CREATE TABLE %s (%s integer, %s longblob) ENGINE=MyISAM DEFAULT CHARSET=latin1 AS SELECT %s.%s AS %s, oph_abs_array(%s.%s,%s.%s,'oph_%s','oph_%s') AS %s FROM %s.%s, %s.%s WHERE %s.%s = %s.%s"

#define OPH_INTERCUBE_QUERY2_COMPR_MYSQL_ARG "CREATE TABLE %s (%s integer, %s longblob) ENGINE=MyISAM DEFAULT CHARSET=latin1 AS SELECT %s.%s AS %s, oph_compress(oph_arg_array(oph_uncompress(%s.%s),oph_uncompress(%s.%s),'oph_%s','oph_%s')) AS %s FROM %s.%s, %s.%s WHERE %s.%s = %s.%s"
#define OPH_INTERCUBE_QUERY2_MYSQL_ARG "CREATE TABLE %s (%s integer, %s longblob) ENGINE=MyISAM DEFAULT CHARSET=latin1 AS SELECT %s.%s AS %s, oph_arg_array(%s.%s,%s.%s,'oph_%s','oph_%s') AS %s FROM %s.%s, %s.%s WHERE %s.%s = %s.%s"

#define OPH_INTERCUBE_QUERY2_COMPR_MYSQL_MASK "CREATE TABLE %s (%s integer, %s longblob) ENGINE=MyISAM DEFAULT CHARSET=latin1 AS SELECT %s.%s AS %s, oph_compress(oph_mask_array(oph_uncompress(%s.%s),oph_uncompress(%s.%s),'oph_%s','oph_%s')) AS %s FROM %s.%s, %s.%s WHERE %s.%s = %s.%s"
#define OPH_INTERCUBE_QUERY2_MYSQL_MASK "CREATE TABLE %s (%s integer, %s longblob) ENGINE=MyISAM DEFAULT CHARSET=latin1 AS SELECT %s.%s AS %s, oph_mask_array(%s.%s,%s.%s,'oph_%s','oph_%s') AS %s FROM %s.%s, %s.%s WHERE %s.%s = %s.%s"
