...
#define MYSQL_QUERY_META_INSERT_INSTANCES			"INSERT INTO `metadatainstance` (`iddatacube`, `idkey`, `idtype`, `value`) SELECT %d, `idkey`, `idtype`, `value` FROM metadatainstance_tmp;"
