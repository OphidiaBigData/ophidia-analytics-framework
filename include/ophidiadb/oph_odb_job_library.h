...
typedef enum { OPH_ODB_JOB_STATUS_UNKNOWN, OPH_ODB_JOB_STATUS_PENDING, OPH_ODB_JOB_STATUS_RUNNING, OPH_ODB_JOB_STATUS_START, OPH_ODB_JOB_STATUS_SET_ENV, OPH_ODB_JOB_STATUS_INIT, OPH_ODB_JOB_STATUS_DISTRIBUTE, OPH_ODB_JOB_STATUS_EXECUTE, OPH_ODB_JOB_STATUS_REDUCE, OPH_ODB_JOB_STATUS_DESTROY, OPH_ODB_JOB_STATUS_UNSET_ENV, OPH_ODB_JOB_STATUS_WAIT, OPH_ODB_JOB_STATUS_COMPLETED, OPH_ODB_JOB_STATUS_ERROR, OPH_ODB_JOB_STATUS_PENDING_ERROR, OPH_ODB_JOB_STATUS_RUNNING_ERROR, OPH_ODB_JOB_STATUS_START_ERROR, OPH_ODB_JOB_STATUS_SET_ENV_ERROR, OPH_ODB_JOB_STATUS_INIT_ERROR, OPH_ODB_JOB_STATUS_DISTRIBUTE_ERROR, OPH_ODB_JOB_STATUS_EXECUTE_ERROR, OPH_ODB_JOB_STATUS_REDUCE_ERROR, OPH_ODB_JOB_STATUS_DESTROY_ERROR, OPH_ODB_JOB_STATUS_UNSET_ENV_ERROR, OPH_ODB_JOB_STATUS_EXPIRED, OPH_ODB_JOB_STATUS_CLOSED } oph_odb_job_status;
