...
int task_execute(oph_operator_struct *handle)
{
  ...
  if(hierarchy_name){
    ...
    //Show list of hierarchies
	  ...
	  int objkey_printable = oph_json_is_objkey_printable(((OPH_HIERARCHY_operator_handle*)handle->operator_handle)->objkeys,((OPH_HIERARCHY_operator_handle*)handle->operator_handle)->objkeys_num,OPH_JSON_OBJKEY_HIERARCHY_LIST);
	  if (objkey_printable) {
		  char **jsonkeys = NULL;
  	...
  	if (oph_json_is_objkey_printable(((OPH_HIERARCHY_operator_handle*)handle->operator_handle)->objkeys,((OPH_HIERARCHY_operator_handle*)handle->operator_handle)->objkeys_num,OPH_JSON_OBJKEY_HIERARCHY_TIP)) {
