...
#ifndef __OPH_IMPORTESDM_OPERATOR_H
#define __OPH_IMPORTESDM_OPERATOR_H
...
/**
 * \brief Structure of parameters needed by the operator OPH_IMPORTESDM. It creates a new datacube filling it with data taken from nc file
 *
...
#endif				//__OPH_IMPORTESDM_OPERATOR_H
