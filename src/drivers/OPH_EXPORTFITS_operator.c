...
int env_set (HASHTBL *task_tbl, oph_operator_struct *handle)
{
  ...
  if(oph_tp_parse_multiple_value_param(value, &((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->objkeys, &((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->objkeys_num)){
  ...
  if(!value){
    ...
    logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTFITS_MISSING_INPUT_PARAMETER, OPH_IN_PARAM_SCHEDULE_ALGORITHM );
  ...
  if(!strcmp(value,OPH_COMMON_YES_VALUE)) ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->misc = 1;
  ...
  if(!strcmp(value,"default"))
  {
	if (((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->misc)
	{
		...
		if(n >= OPH_TP_TASKLEN)
		{
			...
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTFITS_STRING_BUFFER_OVERFLOW, "path", OPH_FRAMEWORK_NC_FILES_PATH);
			return OPH_ANALYTICS_OPERATOR_MEMORY_ERR;
		}
		if(!(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->output_path = (char*)malloc(n*sizeof(char)))){
			pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTFITS_MEMORY_ERROR_INPUT, "output path");
			return OPH_ANALYTICS_OPERATOR_MEMORY_ERR;
		}
		n = snprintf(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->output_path, n, OPH_FRAMEWORK_MISCELLANEA_FILES_PATH"/%s",oph_pid_path()?oph_pid_path():OPH_PREFIX_CLUSTER,session_code,value);
		if (oph_pid_uri())
		{
	...
	{
		int n = snprintf(NULL, 0, OPH_FRAMEWORK_NC_FILES_PATH,oph_pid_path()?oph_pid_path():OPH_PREFIX_CLUSTER,session_code,((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container,((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_datacube) + 1;
		if(n >= OPH_TP_TASKLEN)
		{
			pmesg(LOG_ERROR, __FILE__, __LINE__, "Size of path exceeded limit.\n");
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTFITS_STRING_BUFFER_OVERFLOW, "path", OPH_FRAMEWORK_NC_FILES_PATH);
		...
		n = snprintf(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->output_path, n, OPH_FRAMEWORK_NC_FILES_PATH,oph_pid_path()?oph_pid_path():OPH_PREFIX_CLUSTER, session_code,((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container,((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_datacube);
		if (oph_pid_uri())
		{
			char tmp[OPH_COMMON_BUFFER_LEN];
			snprintf(tmp, OPH_COMMON_BUFFER_LEN, OPH_FRAMEWORK_NC_FILES_PATH, oph_pid_uri(), session_code,((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container,((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_datacube);
			((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->output_link = strdup(tmp);
		}
	}
  } else {
  ...
  if(strcmp(value,"default")){
	  if(!(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->output_name = (char*) strdup(value))){
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
		logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTFITS_MEMORY_ERROR_INPUT, "output name");
	    return OPH_ANALYTICS_OPERATOR_MEMORY_ERR;
	  }
  }
  size_t s;
  if(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->output_name)
  {
	  for (s = 0; s < strlen(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->output_name); s++) {
		  if ((((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->output_name[s] == '/') || (((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->output_name[s] == ':')) {
  ...
  if(!strcmp(value,OPH_COMMON_YES_VALUE)) ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->force = 1;
...
int task_init (oph_operator_struct *handle)
{
  ...
  if(handle->proc_rank == 0){
	...
	if(!(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->fragment_ids = (char *) strndup (cube.frag_relative_index_set, OPH_ODB_CUBE_FRAG_REL_INDEX_SET_SIZE)) || ! (((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->measure_type = (char *) strndup (cube.measure_type, OPH_ODB_CUBE_MEASURE_TYPE_SIZE)) || ! (((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->measure = (char *) strndup (cube.measure, OPH_ODB_CUBE_MEASURE_SIZE))){
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
	...
	if(stat(path,&st)){
		if(oph_dir_r_mkdir(path)){
			...
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTFITS_DIR_CREATION_ERROR, path );		
			goto __OPH_EXIT_1;
		}
	}
...
__OPH_EXIT_1:
  ...
  if(handle->proc_rank != 0){
	  ...
	  if(!(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->measure = (char *) strndup (id_string[1], OPH_ODB_CUBE_FRAG_REL_INDEX_SET_SIZE))){
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
		logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTFITS_MEMORY_ERROR_INPUT, "measure name");
		return OPH_ANALYTICS_OPERATOR_MEMORY_ERR;
	  }
	  if(!(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->measure_type = (char *) strndup (id_string[2], OPH_ODB_CUBE_FRAG_REL_INDEX_SET_SIZE))){
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
		logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTFITS_MEMORY_ERROR_INPUT, "measure type");
		return OPH_ANALYTICS_OPERATOR_MEMORY_ERR;
	  }
  ...
  if(!((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->dims){
	pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
	logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTFITS_MEMORY_ERROR_INPUT, "NETCDF dimensions");
	free(stream_broad);
	return OPH_ANALYTICS_OPERATOR_MEMORY_ERR;
  }
  ...
  for (i = 0; i < ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->num_of_dims; i++){
		...
		if( oph_fits_get_fits_type(stream_broad+((i*OPH_DIM_STREAM_ELEMENTS+2)*OPH_DIM_STREAM_LENGTH), (int*) &(dims[i].dimtype)) ){
			...
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTFITS_VAR_TYPE_NOT_SUPPORTED, stream_broad+((i*OPH_DIM_STREAM_ELEMENTS+2)*OPH_DIM_STREAM_LENGTH) );
			free(stream_broad);
			return OPH_ANALYTICS_OPERATOR_UTILITY_ERROR;
		}
...
int task_distribute(oph_operator_struct *handle)
{
  ...
  if(fragment_number == 0){
	...
	if(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->fragment_id_start_position >= id_number) ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->fragment_id_start_position = -1;	
  }
  ...
  if(oph_ids_get_substring_from_string(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->fragment_ids, ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->fragment_id_start_position, fragment_number, &new_ptr)){
...
int task_execute(oph_operator_struct *handle)
{
	...
	MPI_Comm scomm;
	int color = 0; 
	if (handle->proc_rank && (((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->fragment_id_start_position < 0)) color = MPI_UNDEFINED;
	...
	if (!color)
	{
		  ...
		  for(i = 0; i < num_of_dims; i++) {
			...
			if (dims[i].dimexplicit) nexp++;
		  }

		  int total_size = 1;
		  for(inc = 0; inc < nexp; inc++) total_size *= dims_size[inc];
		  ...
		  if( oph_fits_get_fits_type(data_type, &type_fits) ){
			pmesg(LOG_ERROR, __FILE__, __LINE__, "Variable type not supported\n");
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTFITS_VAR_TYPE_NOT_SUPPORTED, data_type );		
		  ...
		  if(oph_dim_check_if_dimension_table_exists(db_dimension, index_dimension_table_name, &exist_flag))
		  {
			...
			logging(LOG_ERROR, __FILE__, __LINE__,  ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTFITS_DIM_TABLE_RETREIVE_ERROR, index_dimension_table_name );
			oph_dim_disconnect_from_dbms(db_dimension->dbms_instance);
			oph_dim_unload_dim_dbinstance(db_dimension);
			oph_odb_stge_free_fragment_list(&frags);
			oph_odb_stge_free_db_list(&dbs);
		  ...
		  {
			pmesg(LOG_ERROR, __FILE__, __LINE__, "Error while retrieving dimension table\n");
			logging(LOG_ERROR, __FILE__, __LINE__,  ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTFITS_DIM_TABLE_RETREIVE_ERROR, label_dimension_table_name );
			oph_dim_disconnect_from_dbms(db_dimension->dbms_instance);
			oph_dim_unload_dim_dbinstance(db_dimension);
			oph_odb_stge_free_fragment_list(&frags);
			oph_odb_stge_free_db_list(&dbs);
		  ...
		  for(m = 0; m < num_of_dims; m++){
			...
			if(n >= OPH_COMMON_BUFFER_LEN)
			{
				...
				logging(LOG_ERROR, __FILE__, __LINE__,  ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTFITS_STRING_BUFFER_OVERFLOW, "MySQL operation name", operation);    		
				oph_dim_disconnect_from_dbms(db_dimension->dbms_instance);
				oph_dim_unload_dim_dbinstance(db_dimension);
				oph_odb_stge_free_fragment_list(&frags);
				oph_odb_stge_free_db_list(&dbs);
		...
		if(oph_dc2_setup_dbms(&(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->server), (dbmss.value[0]).io_server_type))
		{
			pmesg(LOG_ERROR, __FILE__, __LINE__, "Unable to initialize IO server.\n");
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTFITS_IOPLUGIN_SETUP_ERROR, (dbmss.value[0]).id_dbms);    
			oph_odb_stge_free_fragment_list(&frags);
			oph_odb_stge_free_db_list(&dbs);
			oph_odb_stge_free_dbms_list(&dbmss);
			for(l = 0; l < num_of_dims; l++){
		...
		{
			pmesg(LOG_ERROR, __FILE__, __LINE__, "Size of path exceeded limit.\n");
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTFITS_STRING_BUFFER_OVERFLOW, "path", file_name);    				
			oph_odb_stge_free_fragment_list(&frags);
			oph_odb_stge_free_db_list(&dbs);
			oph_odb_stge_free_dbms_list(&dbmss);
			for(l = 0; l < num_of_dims; l++){
		...
		if(fstatus)
		{
			...
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTFITS_FITS_OUTPUT_FILE_ERROR, err_text);
			oph_odb_stge_free_fragment_list(&frags);
			oph_odb_stge_free_db_list(&dbs);
			oph_odb_stge_free_dbms_list(&dbmss);
			for(l = 0; l < num_of_dims; l++){
		...
		for (inc = 0; inc < num_of_dims; inc++)
		{
			if (dims[inc].dimunlimited)
			{
				...
				logging(LOG_WARNING, __FILE__, __LINE__, ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container, "Support for unlimited dimensions is not provided. '%s' will be stored as a limited dimension\n", dims[inc].dimname);
			}
		}
...
*/
		...
		{
			if(oph_dc2_connect_to_dbms(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->server, &(dbmss.value[i]), 0))
			{
				pmesg(LOG_ERROR, __FILE__, __LINE__, "Unable to connect to DBMS. Check access parameters.\n");
				logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTFITS_DBMS_CONNECTION_ERROR, (dbmss.value[i]).id_dbms);    
				oph_dc2_disconnect_from_dbms(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->server, &(dbmss.value[i]));
		    		oph_dc2_cleanup_dbms(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->server);
				oph_odb_stge_free_fragment_list(&frags);
				oph_odb_stge_free_db_list(&dbs);
				oph_odb_stge_free_dbms_list(&dbmss);
			...
			for(j = 0; j < dbs.size; j++)
			{
				...
				if(oph_dc2_use_db_of_dbms(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->server, &(dbmss.value[i]), &(dbs.value[j])))
				{
					pmesg(LOG_ERROR, __FILE__, __LINE__, "Unable to use the DB. Check access parameters.\n");
					logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTFITS_DB_SELECTION_ERROR, (dbs.value[j]).db_name);    
					oph_dc2_disconnect_from_dbms(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->server, &(dbmss.value[i]));
		    			oph_dc2_cleanup_dbms(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->server);
					oph_odb_stge_free_fragment_list(&frags);
					oph_odb_stge_free_db_list(&dbs);
				...
				for(k = 0; k < frags.size; k++){
					...
					for(m = 0; m < num_of_dims; m++)
					{
						if ((m < nexp) && (dim_val_max[m] < dim_val_min[m])) 
						{
							...
							logging(LOG_WARNING, __FILE__, __LINE__, ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container, "This cube could be too fragmented to be exported correctly. Try to merge it\n");		
							continue;
						}
...
/*
						...
						switch(dims[m].dimtype){
							...
							default:
								...
								oph_dc2_disconnect_from_dbms(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->server, frags.value[k].db_instance->dbms_instance);
								oph_dc2_cleanup_dbms(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->server);
								oph_odb_stge_free_fragment_list(&frags);
								oph_odb_stge_free_db_list(&dbs);
								oph_odb_stge_free_dbms_list(&dbmss);
...
*/
					...
					if(oph_dc2_read_fragment_data(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->server, &(frags.value[k]), data_type, compressed, NULL, NULL, NULL, 0, 1,&frag_rows))
					{
						pmesg(LOG_ERROR, __FILE__, __LINE__, "Unable to read fragment.\n");
						logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTFITS_READ_FRAG_ERROR, (frags.value[k]).fragment_name);    				
					...
					if(frag_rows->num_fields != 2){
						...
						logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTFITS_MISSING_FIELDS);
						oph_ioserver_free_result(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->server, frag_rows);
						oph_dc2_disconnect_from_dbms(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->server, frags.value[k].db_instance->dbms_instance);
						oph_dc2_cleanup_dbms(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->server);
						oph_odb_stge_free_fragment_list(&frags);
...
*/
						...
						if(fstatus){
							fits_get_errstatus(fstatus, err_text);
							pmesg(LOG_ERROR, __FILE__, __LINE__, "Unable to write variable values: %s\n", err_text);
							logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTFITS_VAR_WRITE_ERROR, err_text);
							oph_ioserver_free_result(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->server, frag_rows);
							oph_dc2_disconnect_from_dbms(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->server, frags.value[k].db_instance->dbms_instance);
							oph_dc2_cleanup_dbms(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->server);
							oph_odb_stge_free_fragment_list(&frags);
		  ...
		  if(oph_dc2_cleanup_dbms(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->server))
		  {
			pmesg(LOG_ERROR, __FILE__, __LINE__, "Unable to finalize IO server.\n");
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTFITS_IOPLUGIN_CLEANUP_ERROR, (dbmss.value[0]).id_dbms);
		  }
		  oph_odb_stge_free_fragment_list(&frags);
		  oph_odb_stge_free_db_list(&dbs);
		  oph_odb_stge_free_dbms_list(&dbmss);
		...
		fits_close_file(fptr, &fstatus);
		  ...
		  if(!handle->proc_rank && ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->output_link)
		  {
			...
			snprintf(jsonbuf,OPH_COMMON_BUFFER_LEN, OPH_EXPORTFITS_OUTPUT_PATH_SINGLE_FILE, ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->output_link, ((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->output_name);

			// ADD OUTPUT PID TO JSON AS TEXT
			if (oph_json_is_objkey_printable(((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->objkeys,((OPH_EXPORTFITS_operator_handle*)handle->operator_handle)->objkeys_num,OPH_JSON_OBJKEY_EXPORTFITS)) {
