	...
	if (global_error) {
		...
		int num_threads =
		    (((OPH_SPLIT_operator_handle *) handle->operator_handle)->nthread <=
		     ((OPH_SPLIT_operator_handle *) handle->operator_handle)->fragment_number ? ((OPH_SPLIT_operator_handle *) handle->operator_handle)->
		     nthread : ((OPH_SPLIT_operator_handle *) handle->operator_handle)->fragment_number);
