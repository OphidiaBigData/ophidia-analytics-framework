...
#ifndef __OPH_CONCATNC2_OPERATOR_H
#define __OPH_CONCATNC2_OPERATOR_H
...
/**
 * \brief Structure of parameters needed by the operator OPH_CONCATNC2. It creates a new datacube concatenating data taken from nc file to a cube
 *
...
#endif				//__OPH_CONCATNC2_OPERATOR_H
