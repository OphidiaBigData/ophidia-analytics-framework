	...
	if (global_error) {
		...
		int num_threads =
		    (((OPH_ROLLUP_operator_handle *) handle->operator_handle)->nthread <=
		     ((OPH_ROLLUP_operator_handle *) handle->operator_handle)->fragment_number ? ((OPH_ROLLUP_operator_handle *) handle->
												  operator_handle)->nthread : ((OPH_ROLLUP_operator_handle *) handle->operator_handle)->
		     fragment_number);
