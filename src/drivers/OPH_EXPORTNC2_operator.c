...
int env_set (HASHTBL *task_tbl, oph_operator_struct *handle)
{
  ...
  if(!strcmp(value,OPH_COMMON_YES_VALUE)) ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->export_metadata = 1;
  ...
  if(!value){
    ...
    logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTNC_MISSING_INPUT_PARAMETER, OPH_IN_PARAM_SCHEDULE_ALGORITHM );
  ...
  if(!strcmp(value,OPH_COMMON_YES_VALUE)) ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->misc = 1;
  ...
  if(!strcmp(value,"default"))
  {
	if (((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->misc)
	{
		...
		if(n >= OPH_TP_TASKLEN)
		{
			...
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTNC_STRING_BUFFER_OVERFLOW, "path", OPH_FRAMEWORK_NC_FILES_PATH);
			return OPH_ANALYTICS_OPERATOR_MEMORY_ERR;
		}
		...
		n = snprintf(((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->output_path, n, OPH_FRAMEWORK_MISCELLANEA_FILES_PATH"/%s",oph_pid_path()?oph_pid_path():OPH_PREFIX_CLUSTER,session_code,value);
		if (oph_pid_uri())
		{
	...
	{
		int n = snprintf(NULL, 0, OPH_FRAMEWORK_NC_FILES_PATH,oph_pid_path()?oph_pid_path():OPH_PREFIX_CLUSTER,session_code,((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_container,((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_datacube) + 1;
		if(n >= OPH_TP_TASKLEN)
		{
			pmesg(LOG_ERROR, __FILE__, __LINE__, "Size of path exceeded limit.\n");
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTNC_STRING_BUFFER_OVERFLOW, "path", OPH_FRAMEWORK_NC_FILES_PATH);
		...
		n = snprintf(((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->output_path, n, OPH_FRAMEWORK_NC_FILES_PATH,oph_pid_path()?oph_pid_path():OPH_PREFIX_CLUSTER, session_code,((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_container,((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_datacube);
		if (oph_pid_uri())
		{
			char tmp[OPH_COMMON_BUFFER_LEN];
			snprintf(tmp, OPH_COMMON_BUFFER_LEN, OPH_FRAMEWORK_NC_FILES_PATH, oph_pid_uri(), session_code,((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_container,((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_datacube);
			((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->output_link = strdup(tmp);
		}
	}
  } else {
  ...
  if(((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->output_name)
  {
	  for (s = 0; s < strlen(((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->output_name); s++) {
		  if ((((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->output_name[s] == '/') || (((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->output_name[s] == ':')) {
...
int task_init (oph_operator_struct *handle)
{
  ...
  if(handle->proc_rank == 0){
	...
	if(!(((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->fragment_ids = (char *) strndup (cube.frag_relative_index_set, OPH_ODB_CUBE_FRAG_REL_INDEX_SET_SIZE)) || ! (((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->measure_type = (char *) strndup (cube.measure_type, OPH_ODB_CUBE_MEASURE_TYPE_SIZE)) || ! (((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->measure = (char *) strndup (cube.measure, OPH_ODB_CUBE_MEASURE_SIZE))){
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
...
__OPH_EXIT_1:
  ...
  if(handle->proc_rank != 0){
	  ...
	  if(!(((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->measure = (char *) strndup (id_string[1], OPH_ODB_CUBE_FRAG_REL_INDEX_SET_SIZE))){
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
		logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTNC_MEMORY_ERROR_INPUT, "measure name");
		return OPH_ANALYTICS_OPERATOR_MEMORY_ERR;
	  }
	  if(!(((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->measure_type = (char *) strndup (id_string[2], OPH_ODB_CUBE_FRAG_REL_INDEX_SET_SIZE))){
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
		logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTNC_MEMORY_ERROR_INPUT, "measure type");
		return OPH_ANALYTICS_OPERATOR_MEMORY_ERR;
	  }
  ...
  for (i = 0; i < ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->num_of_dims; i++){
		...
		if( oph_nc_get_nc_type(stream_broad+((i*OPH_DIM_STREAM_ELEMENTS+2)*OPH_DIM_STREAM_LENGTH), &(dims[i].dimtype)) ){
			...
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTNC_VAR_TYPE_NOT_SUPPORTED, stream_broad+((i*OPH_DIM_STREAM_ELEMENTS+2)*OPH_DIM_STREAM_LENGTH) );
			free(stream_broad);
			return OPH_ANALYTICS_OPERATOR_UTILITY_ERROR;
		}
...
int task_distribute(oph_operator_struct *handle)
{
  ...
  if(fragment_number == 0){
	...
	if(((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->fragment_id_start_position >= id_number) ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->fragment_id_start_position = -1;	
  }
  ...
  if(oph_ids_get_substring_from_string(((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->fragment_ids, ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->fragment_id_start_position, fragment_number, &new_ptr)){
...
int task_execute(oph_operator_struct *handle)
{
	...
	if (!color)
	{
		  ...
		  if(oph_dim_check_if_dimension_table_exists(db_dimension, index_dimension_table_name, &exist_flag))
		  {
			...
			logging(LOG_ERROR, __FILE__, __LINE__,  ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTNC_DIM_TABLE_RETREIVE_ERROR, index_dimension_table_name );
			oph_dim_disconnect_from_dbms(db_dimension->dbms_instance);
			oph_dim_unload_dim_dbinstance(db_dimension);
			oph_odb_stge_free_fragment_list(&frags);
			oph_odb_stge_free_db_list(&dbs);
		  ...
		  {
			pmesg(LOG_ERROR, __FILE__, __LINE__, "Error while retrieving dimension table\n");
			logging(LOG_ERROR, __FILE__, __LINE__,  ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTNC_DIM_TABLE_RETREIVE_ERROR, label_dimension_table_name );
			oph_dim_disconnect_from_dbms(db_dimension->dbms_instance);
			oph_dim_unload_dim_dbinstance(db_dimension);
			oph_odb_stge_free_fragment_list(&frags);
			oph_odb_stge_free_db_list(&dbs);
		  ...
		  for(m = 0; m < num_of_dims; m++){
			...
			if(n >= OPH_COMMON_BUFFER_LEN)
			{
				...
				logging(LOG_ERROR, __FILE__, __LINE__,  ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTNC_STRING_BUFFER_OVERFLOW, "MySQL operation name", operation);    		
				oph_dim_disconnect_from_dbms(db_dimension->dbms_instance);
				oph_dim_unload_dim_dbinstance(db_dimension);
				oph_odb_stge_free_fragment_list(&frags);
				oph_odb_stge_free_db_list(&dbs);
		...
		if(oph_dc2_setup_dbms(&(((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->server), (dbmss.value[0]).io_server_type))
		{
			...
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTNC_IOPLUGIN_SETUP_ERROR, (dbmss.value[0]).id_dbms);    
			oph_odb_stge_free_fragment_list(&frags);
			oph_odb_stge_free_db_list(&dbs);
			oph_odb_stge_free_dbms_list(&dbmss);
			for(l = 0; l < num_of_dims; l++){
		...
		{
			pmesg(LOG_ERROR, __FILE__, __LINE__, "Size of path exceeded limit.\n");
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTNC_STRING_BUFFER_OVERFLOW, "path", file_name);    				
			oph_odb_stge_free_fragment_list(&frags);
			oph_odb_stge_free_db_list(&dbs);
			oph_odb_stge_free_dbms_list(&dbmss);
			for(l = 0; l < num_of_dims; l++){
		...
		if((retval = nc_create_par(file_name, cmode, scomm, MPI_INFO_NULL, &ncid)))
		{
			...
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTNC_NC_OUTPUT_FILE_ERROR,  nc_strerror(retval));
			oph_odb_stge_free_fragment_list(&frags);
			oph_odb_stge_free_db_list(&dbs);
			oph_odb_stge_free_dbms_list(&dbmss);
			for(l = 0; l < num_of_dims; l++){
		...
		for (inc = 0; inc < num_of_dims; inc++)
		{
			if((retval = nc_def_dim(ncid, dims[inc].dimname, dims[inc].dimunlimited ? NC_UNLIMITED : dims[inc].dimsize, &dimids[inc]))){
				...
				logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTNC_NC_DEFINE_DIM_ERROR,  dims[inc].dimname, nc_strerror(retval));
				oph_odb_stge_free_fragment_list(&frags);
				oph_odb_stge_free_db_list(&dbs);
				oph_odb_stge_free_dbms_list(&dbmss);
				for(l = 0; l < num_of_dims; l++){
		...
		if((retval = nc_enddef (ncid))){
			...
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTNC_NC_END_DEFINITION_ERROR, nc_strerror(retval));
			oph_odb_stge_free_fragment_list(&frags);
			oph_odb_stge_free_db_list(&dbs);
			oph_odb_stge_free_dbms_list(&dbmss);
			nc_close(ncid);
		...
		if(((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->export_metadata) // Add metadata
		{
			...
			else // Master
			{
				...
				MYSQL_ROW row;
				if(oph_odb_meta_find_complete_metadata_list(&((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->oDB, ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_datacube, NULL, 0, NULL, NULL, NULL, &read_result))
				{
		...
		for(i = 0; i < dbmss.size; i++)
		{
			if(oph_dc2_connect_to_dbms(((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->server, &(dbmss.value[i]), 0))
			{
				...
				logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTNC_DBMS_CONNECTION_ERROR, (dbmss.value[i]).id_dbms);    
			...
			for(j = 0; j < dbs.size; j++)
			{
				...
				if(oph_dc2_use_db_of_dbms(((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->server, &(dbmss.value[i]), &(dbs.value[j])))
				{
					...
					logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTNC_DB_SELECTION_ERROR, (dbs.value[j]).db_name);    
					oph_dc2_disconnect_from_dbms(((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->server, &(dbmss.value[i]));
		    			oph_dc2_cleanup_dbms(((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->server);
					oph_odb_stge_free_fragment_list(&frags);
					oph_odb_stge_free_db_list(&dbs);
				...
				for(k = 0; k < frags.size; k++){
					...
					for(m = 0; m < num_of_dims; m++)
					{
						if ((m < nexp) && (dim_val_max[m] < dim_val_min[m])) 
						{
							...
							logging(LOG_WARNING, __FILE__, __LINE__, ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_container, "This cube could be too fragmented to be exported correctly. Try to merge it\n");		
							continue;
						}
						...
						switch(dims[m].dimtype){
							...
							default:
								pmesg(LOG_ERROR, __FILE__, __LINE__, "Variable type not supported\n");
								logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTNC_VAR_TYPE_NOT_SUPPORTED, dims[m].dimtype);		
						...
						if(retval){
							...
							logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTNC_VAR_WRITE_ERROR, nc_strerror(retval));
							oph_dc2_disconnect_from_dbms(((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->server, frags.value[k].db_instance->dbms_instance);
							oph_dc2_cleanup_dbms(((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->server);
							oph_odb_stge_free_fragment_list(&frags);
							oph_odb_stge_free_db_list(&dbs);
					...
					if(oph_dc2_read_fragment_data(((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->server, &(frags.value[k]), data_type, compressed, NULL, NULL, NULL, 0, 1,&frag_rows))
					{
						pmesg(LOG_ERROR, __FILE__, __LINE__, "Unable to read fragment.\n");
						logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTNC_READ_FRAG_ERROR, (frags.value[k]).fragment_name);    				
					...
					if(frag_rows->num_fields != 2){
						...
						logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTNC_MISSING_FIELDS);
						oph_ioserver_free_result(((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->server, frag_rows);
						oph_dc2_disconnect_from_dbms(((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->server, frags.value[k].db_instance->dbms_instance);
						oph_dc2_cleanup_dbms(((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->server);
						oph_odb_stge_free_fragment_list(&frags);
					...
					do
					{
						...
						if (memory_size_mb)
							for(inc = 0; inc < nexp; inc++) count[inc] = 1;
		  ...
		  if(oph_dc2_cleanup_dbms(((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->server))
		  {
			...
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_EXPORTNC_IOPLUGIN_CLEANUP_ERROR, (dbmss.value[0]).id_dbms);
		  }
		  oph_odb_stge_free_fragment_list(&frags);
		  oph_odb_stge_free_db_list(&dbs);
		  oph_odb_stge_free_dbms_list(&dbmss);
		  ...
		  if(!handle->proc_rank && ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->output_link)
		  {
			...
			snprintf(jsonbuf,OPH_COMMON_BUFFER_LEN, OPH_EXPORTNC2_OUTPUT_PATH_SINGLE_FILE, ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->output_link, ((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->output_name);

			// ADD OUTPUT PID TO JSON AS TEXT
			if (oph_json_is_objkey_printable(((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->objkeys,((OPH_EXPORTNC2_operator_handle*)handle->operator_handle)->objkeys_num,OPH_JSON_OBJKEY_EXPORTNC2)) {
