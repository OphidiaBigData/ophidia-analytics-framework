...
#ifndef __OPH_IMPORTNC5_OPERATOR_H
#define __OPH_IMPORTNC5_OPERATOR_H
...
#define OPH_IMPORTNC5_SUBSET_INDEX	    "index"
#define OPH_IMPORTNC5_SUBSET_COORD	    "coord"
#define OPH_IMPORTNC5_DIMENSION_DEFAULT	"auto"

//Only import of measured variables is supported

/**
 * \brief Structure of parameters needed by the operator OPH_IMPORTNC5. It creates a new datacube filling it with data taken from nc file
 *
 ...
 */
struct _OPH_IMPORTNC5_operator_handle {
	ophidiadb oDB;
...
typedef struct _OPH_IMPORTNC5_operator_handle OPH_IMPORTNC5_operator_handle;

#endif				//__OPH_IMPORTNC5_OPERATOR_H
