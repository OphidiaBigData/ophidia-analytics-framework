...
int env_set(HASHTBL * task_tbl, oph_operator_struct * handle)
{
	...
	if (value && !strcmp(value, OPH_COMMON_NO_VALUE))
		((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->time_filter = 0;
	...
	if (((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->host_number == 0)
		((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->host_number = -1;	// All the host of the partition
	...
	if (((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->dbmsxhost_number == 0)
		((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->dbmsxhost_number = -1;	// All the DBMS of the host
	...
	if (((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->fragxdb_number == 0)
		((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->fragxdb_number = -1;	// The maximum number of fragments

	//Additional check (all distrib arguments must be bigger than 0 or at least -1 if default values are given)
	if (((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->host_number == 0 || ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->dbmsxhost_number == 0
	    || ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->dbxdbms_number == 0 || ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->fragxdb_number == 0) {
...
//ADDED TO MANAGE SUBSETTED IMPORT
			...
			if (handle->proc_rank == 0) {
				...
				while (flag) {
					...
					if ((oph_odb_fs_path_parsing("", ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->cwd, &folder_id, NULL, oDB))) {
						...
						logging(LOG_ERROR, __FILE__, __LINE__, OPH_GENERIC_CONTAINER_ID, OPH_LOG_OPH_IMPORTNC_CWD_ERROR, container_name,
							((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->cwd);
						break;
					}
					if ((oph_odb_fs_check_folder_session(folder_id, ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->sessionid, oDB, &permission)) || !permission) {
						...
						logging(LOG_ERROR, __FILE__, __LINE__, OPH_GENERIC_CONTAINER_ID, OPH_LOG_OPH_IMPORTNC_DATACUBE_PERMISSION_ERROR, container_name,
							((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->user);
						break;
					}
					...
					if (((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->import_metadata) {
						...
						if (!((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->id_vocabulary
						    && oph_odb_meta_retrieve_vocabulary_id_from_container(oDB, id_container_out,
													  &((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->id_vocabulary)) {
						...
						if (update_dim_with_nc_metadata(oDB, time_dim, ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->id_vocabulary, id_container_out, ncid))
							break;
					}
	...
	if (handle->proc_rank == 0) {
		...
		//Default hierarchy
			...
			for (i = 0; i < measure->ndims; i++)
				((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->id_dimension_hierarchy[i] = id_hierarchy;
		}
	}
...
int task_init(oph_operator_struct * handle)
{
	if (!handle || !handle->operator_handle) {
		...
		logging(LOG_ERROR, __FILE__, __LINE__, OPH_GENERIC_CONTAINER_ID, OPH_LOG_OPH_IMPORTNC_NULL_OPERATOR_HANDLE_NO_CONTAINER,
			((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->container_input);
		return OPH_ANALYTICS_OPERATOR_NULL_OPERATOR_HANDLE;
	}
	//For error checking
	...
	if (handle->proc_rank == 0) {
	   ...
	   ********************************/
		...
		if ((!strncmp(host_partition, OPH_COMMON_HOSTPARTITION_DEFAULT, strlen(host_partition))
			...
			if (oph_odb_stge_get_default_host_partition_fs
			    (oDB, &((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->fs_type, ioserver_type, &((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->partition_input,
				...
				if (run) {
					...
					logging(LOG_ERROR, __FILE__, __LINE__, OPH_GENERIC_CONTAINER_ID, OPH_LOG_OPH_IMPORTNC_HOST_DBMS_CONSTRAINT_FAILED_NO_CONTAINER, container_name,
						((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->host_number, ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->dbmsxhost_number,
						host_partition);
					goto __OPH_EXIT_1;
				} else {
			...
			if (*host_number > 0 || *dbmsxhost_number > 0) {
				if ((oph_odb_stge_check_number_of_host_dbms(oDB, storage_type, ioserver_type, host_partition, (*host_number > 0 ? *host_number : 1), *dbmsxhost_number, &exist_part))
					...
					if (run) {
						pmesg(LOG_ERROR, __FILE__, __LINE__, "Requested number of hosts or dbms per host is too big or server type and partition are not available!\n");
						logging(LOG_ERROR, __FILE__, __LINE__, OPH_GENERIC_CONTAINER_ID, OPH_LOG_OPH_IMPORTNC_HOST_DBMS_CONSTRAINT_FAILED_NO_CONTAINER, container_name,
							((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->host_number,
							((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->dbmsxhost_number, host_partition);
						goto __OPH_EXIT_1;
					} else {
						//If simulated run then reset values
						pmesg(LOG_ERROR, __FILE__, __LINE__, "Requested number of hosts or dbms per host is too big or server type and partition are not available!\n");
		...
		if (frag_param_error) {
			...
			int ii = 0;
			for (ii = nhost; ii > 0; ii--) {
				if (((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->total_frag_number % ii == 0)
					break;
			}
		...
		if (!((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->run) {
			...
			if (oph_json_is_objkey_printable
			    (((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->objkeys, ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->objkeys_num,
		...
		if (((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->import_metadata) {
			if (!((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->id_vocabulary
			    && oph_odb_meta_retrieve_vocabulary_id_from_container(oDB, id_container_out, &((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->id_vocabulary)) {
				pmesg(LOG_ERROR, __FILE__, __LINE__, "Unknown vocabulary\n");
				logging(LOG_ERROR, __FILE__, __LINE__, OPH_GENERIC_CONTAINER_ID, OPH_LOG_OPH_IMPORTNC_NO_VOCABULARY_NO_CONTAINER, container_name, "");
				goto __OPH_EXIT_1;
			}
		...
		if (((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->grid_name
		    && !oph_odb_dim_retrieve_grid_id(oDB, ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->grid_name, id_container_out, &id_grid) && id_grid) {
			...
			if (oph_odb_dim_retrieve_dimension_list_from_grid_in_container
			    (oDB, ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->grid_name, id_container_out, &dims, &dim_inst, &dim_inst_num)) {
		  ...
		  ***************************/
			...
			for (i = 0; i < measure->ndims; i++) {
				...
				if (!exists) {
					if (((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->import_metadata && (time_dimension < 0)
	   ...
	   ********************************/
		...
		if (((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->description)
			snprintf(cube.description, OPH_ODB_CUBE_DESCRIPTION_SIZE, "%s", ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->description);
		else
			*cube.description = 0;
	   ...
	   ********************************/
		...
		if (oph_odb_stge_retrieve_dbmsinstance_id_list
		    (oDB, storage_type, ioserver_type, host_partition, ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->host_number,
		     ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->dbmsxhost_number, &id_dbmss, &dbmss_length)) {
		...
		for (j = 0; j < dbmss_length; j++) {
			...
			for (i = 0; i < ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->dbxdbms_number; i++) {
				if (oph_dc2_generate_db_name(oDB->name, id_datacube_out, db.id_dbms, 0, i + 1, &db_name)) {
...
int task_distribute(oph_operator_struct * handle)
{
	...
	if (((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->fragment_number == 0) {
		...
		if (((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->fragment_first_id >= frag_total_number)
			((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->fragment_first_id = -1;
	}
...
int task_execute(oph_operator_struct * handle)
{
	...
	int start_position =
	    (int) floor((double) ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->fragment_first_id / ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->fragxdb_number);
	int row_number =
	    (int) ceil((double) (((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->fragment_first_id + ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->fragment_number) /
		       ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->fragxdb_number) - start_position;
	...
	if (oph_odb_read_ophidiadb_config_file(&oDB_slave)) {
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Unable to read OphidiaDB configuration\n");
		logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_OPHIDIADB_CONFIGURATION_FILE,
			((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->container_input);
	...
	if (oph_odb_connect_to_ophidiadb(&oDB_slave)) {
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Unable to connect to OphidiaDB. Check access parameters.\n");
		logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_OPHIDIADB_CONNECTION_ERROR,
			((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->container_input);
	...
	if (!((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->server) {
		if (oph_dc2_setup_dbms(&(((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->server), dbmss.value[0].io_server_type)) {
			pmesg(LOG_ERROR, __FILE__, __LINE__, "Unable to initialize IO server.\n");
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_IOPLUGIN_SETUP_ERROR,
	...
	for (i = 0; i < dbmss.size; i++) {
		...
		if (oph_dc2_connect_to_dbms(((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->server, &(dbmss.value[i]), 0)) {
			pmesg(LOG_ERROR, __FILE__, __LINE__, "Unable to connect to DBMS. Check access parameters.\n");
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_DBMS_CONNECTION_ERROR,
		...
		for (j = 0; j < dbs.size; j++) {
			...
			if (oph_dc2_use_db_of_dbms(((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->server, &(dbmss.value[i]), &(dbs.value[j]))) {
				...
				logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_DB_SELECTION_ERROR,
					(dbs.value[j]).db_name);
				oph_dc2_disconnect_from_dbms(((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->server, &(dbmss.value[i]));
				oph_odb_stge_free_db_list(&dbs);
				oph_odb_stge_free_dbms_list(&dbmss);
			...
			frag_to_insert =
			    ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->fragxdb_number - (((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->fragment_first_id + frag_count -
													   start_position *
													   ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->fragxdb_number);
			...
			for (k = 0; k < frag_to_insert; k++) {
				...
				new_frag.key_start =
				    ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->fragment_first_id * ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->tuplexfrag_number +
				    frag_count * ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->tuplexfrag_number + 1;
				new_frag.key_end =
				    ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->fragment_first_id * ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->tuplexfrag_number +
				    frag_count * ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->tuplexfrag_number +
				    ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->tuplexfrag_number;
				...
				if (oph_dc2_generate_fragment_name(NULL, id_datacube_out, handle->proc_rank, (frag_count + 1), &fragment_name)) {
					...
					logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->id_input_container,
				...
				if (oph_nc_populate_fragment_from_nc3
				    (((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->server, &new_frag, ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->ncid,
				     ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->tuplexfrag_number, ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->array_length,
				     ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->compressed, (NETCDF_var *) & (((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->measure),
				     ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->memory_size)) {
				...
				frag_count++;
				if (frag_count == ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->fragment_number)
					break;
			}
			start_position++;
		}
	...
	if (handle->proc_rank == 0) {
		...
		if (oph_pid_show_pid
		    (((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->id_input_container, ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->id_output_datacube, tmp_uri)) {
		...
		snprintf(jsonbuf, OPH_COMMON_BUFFER_LEN, OPH_PID_FORMAT, tmp_uri, ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->id_input_container,
			 ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->id_output_datacube);

		// ADD OUTPUT PID TO JSON AS TEXT
		if (oph_json_is_objkey_printable
		    (((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->objkeys, ((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->objkeys_num, OPH_JSON_OBJKEY_IMPORTNC)) {
...
int env_unset(oph_operator_struct * handle)
{
	...
	if (((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->server)
		oph_dc2_cleanup_dbms(((OPH_IMPORTNC3_operator_handle *) handle->operator_handle)->server);
