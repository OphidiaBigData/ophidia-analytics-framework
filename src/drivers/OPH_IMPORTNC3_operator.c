...
#include "drivers/OPH_IMPORTNC3_operator.h"
...
int env_set (HASHTBL *task_tbl, oph_operator_struct *handle)
{
  ...
  if (!(handle->operator_handle = (OPH_IMPORTNC3_operator_handle *) calloc (1, sizeof (OPH_IMPORTNC3_operator_handle)))){
  ...
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->container_input = NULL;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->create_container = 0;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->user = NULL;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->grid_name = NULL;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->nc_file_path = NULL;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_output_datacube = 0;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_input_container = 0;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->compressed = 0;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->import_metadata = 0;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->check_compliance = 0;
  NETCDF_var *nc_measure = &(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->measure);
  ...
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->cwd = NULL;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->user = NULL;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->run = 1;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->objkeys = NULL;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->objkeys_num = -1;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fs_type = 0;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->ioserver_type = NULL;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->server = NULL;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->sessionid = NULL;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_dimension_hierarchy = NULL;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_vocabulary = 0;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->base_time = NULL;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->units = NULL;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->calendar = NULL;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->month_lengths = NULL;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->leap_year = 0;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->leap_month = 2;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->memory_size = 0;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->description = NULL;
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->time_filter = 1;
  ...
  if(oph_tp_parse_multiple_value_param(value, &((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->objkeys, &((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->objkeys_num)){
    pmesg(LOG_ERROR, __FILE__, __LINE__, "Operator string not valid\n");
    logging(LOG_ERROR, __FILE__, __LINE__, OPH_GENERIC_CONTAINER_ID, "Operator string not valid\n");
    oph_tp_free_multiple_value_param_list(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->objkeys, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->objkeys_num);
    return OPH_ANALYTICS_OPERATOR_INVALID_PARAM;
  }
  ...
  if(!(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->sessionid = (char *) strndup (value, OPH_TP_TASKLEN))){
	pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
  ...
  if(!(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->base_time = (char *) strndup (value, OPH_TP_TASKLEN))){
	pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
  ...
  if(!(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->units = (char *) strndup (value, OPH_TP_TASKLEN))){
	pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
  ...
  if(!(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->calendar = (char *) strndup (value, OPH_TP_TASKLEN))){
	pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
  ...
  if(!(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->month_lengths = (char *) strndup (value, OPH_TP_TASKLEN))){
	pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
  ...
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->leap_year = (int)strtol(value, NULL, 10);
  ...
  if (strncmp(value,OPH_COMMON_DEFAULT_EMPTY_VALUE,OPH_TP_TASKLEN)){
	if(!(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->description = (char *) strndup (value, OPH_TP_TASKLEN))){
  ...
  if(value && !strcmp(value,OPH_COMMON_NO_VALUE)) ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->time_filter = 0;
  ...
  if(strncmp(value,OPH_COMMON_YES_VALUE,OPH_TP_TASKLEN) == 0){
	  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->import_metadata = 1;
  }
  ...
  if(!(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->nc_file_path = (char *) strndup (value, OPH_TP_TASKLEN))){
	pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
  ...
  if (!strncmp(value,OPH_COMMON_DEFAULT_EMPTY_VALUE,OPH_TP_TASKLEN))
  {
	((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->create_container = 1;
	char* pointer = strrchr(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->nc_file_path,'/');
	while (pointer && !strlen(pointer))
	{
		*pointer = 0;
		pointer = strrchr(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->nc_file_path,'/');
	}
	container_name = pointer ? pointer+1 : ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->nc_file_path;
  }
  else container_name = value;
  if(!(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->container_input = (char *) strndup (container_name, OPH_TP_TASKLEN))){
	pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
	...
	{
		char *pointer = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->nc_file_path;
  ...
  if(!(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->cwd = (char *) strndup (value, OPH_TP_TASKLEN))){
	pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
  ...
  if(!(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->user = (char *) strndup (value, OPH_TP_TASKLEN))){
	pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
  ...
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->schedule_algo = (int)strtol(value, NULL, 10);
  ...
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->host_number = (int)strtol(value, NULL, 10);
  if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->host_number == 0) ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->host_number = -1; // All the host of the partition
  ...
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->dbmsxhost_number = (int)strtol(value, NULL, 10);
  if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->dbmsxhost_number == 0) ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->dbmsxhost_number = -1; // All the DBMS of the host
  ...
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->dbxdbms_number = (int)strtol(value, NULL, 10); // 'All by means of special value 0' is not defined in this case
  ...
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragxdb_number = (int)strtol(value, NULL, 10);
  if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragxdb_number == 0) ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragxdb_number = -1; // The maximum number of fragments

  //Additional check (all distrib arguments must be bigger than 0 or at least -1 if default values are given)
  if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->host_number == 0 || ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->dbmsxhost_number == 0 || ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->dbxdbms_number == 0 || ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragxdb_number == 0){
  ...
  int ncid = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->ncid;
  ...
  if(strncmp(value, OPH_IMPORTNC3_DIMENSION_DEFAULT, strlen(value)) || strncmp(value, OPH_IMPORTNC3_DIMENSION_DEFAULT, strlen(OPH_IMPORTNC3_DIMENSION_DEFAULT))){
...
//ADDED TO MANAGE SUBSETTED IMPORT
  ...
  int is_index = strncmp(value, OPH_IMPORTNC3_SUBSET_COORD, OPH_TP_TASKLEN);
  ...
  for (i = 0; i < number_of_sub_dims; i++){
	if (((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->time_filter && strchr(sub_filters[i], OPH_DIM_SUBSET_SEPARATOR[1])) {
		if (tf >= 0)
		{
  ...
  if(handle->proc_rank == 0)
  {
	  ...
	  ophidiadb *oDB = &((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->oDB;
	  ...
	  if(strncmp(value, OPH_COMMON_DEFAULT_EMPTY_VALUE, OPH_TP_TASKLEN)){
		  if((oph_odb_meta_retrieve_vocabulary_id(oDB, value, &((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_vocabulary))){
  ...
  if (tf >= 0)
  {
	...
	if (((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->create_container)
	{
		...
		if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->import_metadata)
		{
			...
			if(handle->proc_rank == 0)
			{
				...
				if (update_dim_with_nc_metadata(oDB, time_dim, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_vocabulary, OPH_GENERIC_CONTAINER_ID, ncid))
		...
		if(handle->proc_rank == 0)
		{
			...
			while (flag)
			{
				...
				if((oph_odb_fs_path_parsing("", ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->cwd, &folder_id, NULL, oDB))) {				
					pmesg(LOG_ERROR, __FILE__, __LINE__, "Path %s doesn't exists\n", ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->cwd);
					logging(LOG_ERROR, __FILE__, __LINE__,  OPH_GENERIC_CONTAINER_ID, OPH_LOG_OPH_IMPORTNC_CWD_ERROR, container_name, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->cwd );
					break;
				}
				if((oph_odb_fs_check_folder_session(folder_id, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->sessionid, oDB, &permission)) || !permission){
					pmesg(LOG_ERROR, __FILE__, __LINE__, "User %s is not allowed to work in this folder\n", ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->user);
					logging(LOG_ERROR, __FILE__, __LINE__,  OPH_GENERIC_CONTAINER_ID, OPH_LOG_OPH_IMPORTNC_DATACUBE_PERMISSION_ERROR, container_name, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->user );
					break;
				}
				...
				if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->import_metadata)
				{
					...
					if(!((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_vocabulary && oph_odb_meta_retrieve_vocabulary_id_from_container(oDB, id_container_out, &((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_vocabulary)){
					...
					if (update_dim_with_nc_metadata(oDB, time_dim, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_vocabulary, id_container_out, ncid)) break;
				}
  ...
  if(strncmp(value,OPH_COMMON_YES_VALUE,OPH_TP_TASKLEN) == 0){
        ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->compressed = 1;
  }
  ...
  if(strncmp(value,OPH_COMMON_NO_VALUE,OPH_TP_TASKLEN) == 0){
        ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->run = 0;
  }
  ...
  if(strncmp(value,OPH_COMMON_YES_VALUE,OPH_TP_TASKLEN) == 0){
	  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->check_compliance = 1;
  }
 ...
 if(!(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->partition_input = (char *) strndup (value, OPH_TP_TASKLEN))){
	pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
  ...
  if( strncmp(value,OPH_COMMON_IO_FS_GLOBAL,OPH_TP_TASKLEN) == 0){
  	((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fs_type = OPH_COMMON_IO_FS_GLOBAL_TYPE;
  }
  else if( strncmp(value,OPH_COMMON_IO_FS_LOCAL,OPH_TP_TASKLEN) == 0){
  	((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fs_type = OPH_COMMON_IO_FS_LOCAL_TYPE;
  }
  else{
  	((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fs_type = OPH_COMMON_IO_FS_DEFAULT_TYPE;
  }
  ...
  if(!(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->ioserver_type = (char *) strndup (value, OPH_TP_TASKLEN))){
	pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
  ...
  if(strcasecmp(value, OPH_COMMON_DEFAULT_GRID) != 0){
	 if(!(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->grid_name = (char *) strndup (value, OPH_TP_TASKLEN))){
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
  ...
  if(handle->proc_rank == 0)
  {
	  ...
	  if(strncmp(value, OPH_COMMON_DEFAULT_HIERARCHY, strlen(value)) || strncmp(value, OPH_COMMON_DEFAULT_HIERARCHY, strlen(OPH_COMMON_DEFAULT_HIERARCHY)))
	  {
		  ...
		  if(!(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_dimension_hierarchy = (int*)malloc(number_of_dimensions_hierarchy*sizeof(int )))){
			pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
		  ...
		  memset(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_dimension_hierarchy, 0, number_of_dimensions_hierarchy*sizeof(int));
		  ...
		  for(i = 0; i < number_of_dimensions_hierarchy; i++)
		  {
			  ...
			  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_dimension_hierarchy[m2u[i]] = id_hierarchy;
			  if (!strcasecmp(dim_hierarchy[i],OPH_COMMON_TIME_HIERARCHY))
			  {
				...
				((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_dimension_hierarchy[m2u[i]] *= -1;
				found_oph_time = 1;
			  }
		  }
		  oph_tp_free_multiple_value_param_list(dim_hierarchy, number_of_dimensions_hierarchy);
	  ...
	  {
		if(!(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_dimension_hierarchy = (int*)malloc(measure->ndims*sizeof(int )))){
			pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
			logging(LOG_ERROR, __FILE__, __LINE__, OPH_GENERIC_CONTAINER_ID, OPH_LOG_OPH_IMPORTNC_MEMORY_ERROR_INPUT_NO_CONTAINER, container_name, "id dimension hierarchy");
			return OPH_ANALYTICS_OPERATOR_MEMORY_ERR;
		}
		memset(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_dimension_hierarchy, 0, measure->ndims*sizeof(int));
		...
		for(i = 0; i < measure->ndims; i++) ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_dimension_hierarchy[i] = id_hierarchy;
	  }
  }
...
int task_init (oph_operator_struct *handle)
{
  if (!handle || !handle->operator_handle){
  	pmesg(LOG_ERROR, __FILE__, __LINE__, "Null Handle\n");
	logging(LOG_ERROR, __FILE__, __LINE__, OPH_GENERIC_CONTAINER_ID, OPH_LOG_OPH_IMPORTNC_NULL_OPERATOR_HANDLE_NO_CONTAINER, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->container_input );
	  return OPH_ANALYTICS_OPERATOR_NULL_OPERATOR_HANDLE;
  }
  ...
  NETCDF_var *measure = &((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->measure;
	  ...
	  if(measure->dims_type[i]){
		  if(measure->dims_oph_level[i] > max_lev){
			  ...
			  if(measure->dims_end_index[i] == measure->dims_start_index[i])
				  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->tuplexfrag_number = 1;
			  else
			  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->tuplexfrag_number = measure->dims_end_index[i] - measure->dims_start_index[i]+1;
		  }
	  }
  }

  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->total_frag_number = 1;
  for(i = 0; i < measure->ndims; i++){
	//Consider only explicit dimensions
	//Modified to allow subsetting
	if(measure->dims_type[i] && measure->dims_id[i] != last_dimid){
		if(measure->dims_end_index[i] == measure->dims_start_index[i])
			continue;
		((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->total_frag_number *= (measure->dims_end_index[i] - measure->dims_start_index[i])+1;
	}
  }
  //****COMPUTE DEFAULT fragxdb AND tuplexfrag NUMBER (END)*********//

  // Compute array_length
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->array_length = 1;
  for(i = 0; i < measure->ndims; i++){
	...
	if(!measure->dims_type[i]){
		if(measure->dims_end_index[i] == measure->dims_start_index[i])
			continue;
		((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->array_length *= (measure->dims_end_index[i] - measure->dims_start_index[i])+1;
	}
  }

  char *container_name = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->container_input;
  ...
  if(handle->proc_rank == 0){
	  ...
	  int *host_number = &((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->host_number;
	  int *dbmsxhost_number = &((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->dbmsxhost_number;
	  int *dbxdbms_number = &((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->dbxdbms_number;
	  int *fragxdb_number = &((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragxdb_number;
	  int storage_type = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fs_type;
    char *host_partition = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->partition_input;
	  char *ioserver_type = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->ioserver_type;
	  int run = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->run;
    ...
    int final_frag_number = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->total_frag_number;

    int max_frag_number = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->total_frag_number * ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->tuplexfrag_number;
    ...
    if( (!strncmp(host_partition, OPH_COMMON_HOSTPARTITION_DEFAULT, strlen(host_partition)) && !strncmp(host_partition, OPH_COMMON_HOSTPARTITION_DEFAULT, strlen(OPH_COMMON_HOSTPARTITION_DEFAULT))) || storage_type == OPH_COMMON_IO_FS_DEFAULT_TYPE){
			if(oph_odb_stge_get_default_host_partition_fs(oDB, &((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fs_type, ioserver_type, &((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->partition_input, (*host_number > 0 ? *host_number : 1), *dbmsxhost_number, &exist_part) || !exist_part){
				if(run){			
					...
					logging(LOG_ERROR, __FILE__, __LINE__, OPH_GENERIC_CONTAINER_ID, OPH_LOG_OPH_IMPORTNC_HOST_DBMS_CONSTRAINT_FAILED_NO_CONTAINER, container_name, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->host_number, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->dbmsxhost_number, host_partition );
					goto __OPH_EXIT_1;
				}
				else{
      ...
      host_partition = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->partition_input;
      storage_type = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fs_type;
        ...
        user_arg_prod = (1*(*dbmsxhost_number)*(*dbxdbms_number)*1);
				if(final_frag_number < user_arg_prod){
					...
					if(run){
						...
						logging(LOG_ERROR, __FILE__, __LINE__, OPH_GENERIC_CONTAINER_ID, OPH_LOG_OPH_IMPORTNC_HOST_DBMS_CONSTRAINT3_FAILED_NO_CONTAINER, container_name, final_frag_number);
						goto __OPH_EXIT_1;
					}
					else{
						pmesg(LOG_ERROR, __FILE__, __LINE__, OPH_LOG_OPH_IMPORTNC_HOST_DBMS_CONSTRAINT3_FAILED_NO_CONTAINER, container_name, final_frag_number);
          ...
          if(final_frag_number%user_arg_prod != 0){
            ...
            if(admissible_frag_number  <= nhost){
              ...
              *host_number = ii;
              ...
              ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->tuplexfrag_number = (int)ceilf((float)max_frag_number/((*host_number)*user_arg_prod));
            }
          }
        }        
      }
        ...
        user_arg_prod = ((*host_number)*(*dbmsxhost_number)*(*dbxdbms_number)*(*fragxdb_number));
				if(max_frag_number < user_arg_prod ){
					...
					if(run){
						...
						logging(LOG_ERROR, __FILE__, __LINE__, OPH_GENERIC_CONTAINER_ID, OPH_LOG_OPH_IMPORTNC_HOST_DBMS_CONSTRAINT3_FAILED_NO_CONTAINER, container_name, max_frag_number);
						goto __OPH_EXIT_1;
					}
					else{
						pmesg(LOG_ERROR, __FILE__, __LINE__, OPH_LOG_OPH_IMPORTNC_HOST_DBMS_CONSTRAINT3_FAILED_NO_CONTAINER, container_name, max_frag_number);
          ...
          if(max_frag_number % user_arg_prod != 0){
            ...
            ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->tuplexfrag_number = (int)ceilf((float)max_frag_number/user_arg_prod);
          }
        }        
      }
    }
    ...
    if(frag_param_error)
    {
      ...
      int ii = 0;
      for(ii = nhost; ii > 0; ii--){
        if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->total_frag_number%ii == 0) break;
      }
      ...
      *dbmsxhost_number = 1;
      *dbxdbms_number = 1;
      *fragxdb_number = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->total_frag_number/ii;
    }
    else
    {
      ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->total_frag_number = ((*host_number)*(*dbmsxhost_number)*(*dbxdbms_number)*(*fragxdb_number));
    }

	if(!((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->run)
	{
		...
		printf("\tNumber of tuples per fragment: %d\n", ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->tuplexfrag_number);
		...
		len += snprintf(message + len, OPH_COMMON_BUFFER_LEN, "\tNumber of fragments per database: %d\n", ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragxdb_number);
		len += snprintf(message + len, OPH_COMMON_BUFFER_LEN, "\tNumber of tuples per fragment: %d\n", ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->tuplexfrag_number);

		if (oph_json_is_objkey_printable(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->objkeys,((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->objkeys_num,OPH_JSON_OBJKEY_IMPORTNC))
		{
			if (oph_json_add_text(handle->operator_json,OPH_JSON_OBJKEY_IMPORTNC,"Fragmentation parameters",message))
			{
				pmesg(LOG_ERROR, __FILE__, __LINE__, "ADD TEXT error\n");
				logging(LOG_WARNING,__FILE__,__LINE__,  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_input_container, "ADD TEXT error\n");
			}
		}
		goto __OPH_EXIT_1;
	}
	...
	int ncid = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->ncid;
	char *cwd = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->cwd;
	char *user = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->user;
	NETCDF_var tmp_var;
	...
	if (((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->create_container)
	{
		...
		cont.operation[0] = 0;
		cont.id_vocabulary = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_vocabulary;
		...
		((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_input_container = id_container_out;
		...
		for(i = 0; i < measure->ndims ; i++)
		{
			...
			dim.id_hierarchy = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_dimension_hierarchy[i];
	...
	if(!((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->create_container && oph_odb_fs_retrieve_container_id_from_container_name(oDB, folder_id, container_name, 0, &id_container_out))
	{
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Unknown input container or it is hidden\n");
		logging(LOG_ERROR, __FILE__, __LINE__, OPH_GENERIC_CONTAINER_ID, OPH_LOG_OPH_IMPORTNC_NO_INPUT_CONTAINER_NO_CONTAINER, container_name, container_name );
		goto __OPH_EXIT_1;
	  ...
	  if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->grid_name && !oph_odb_dim_retrieve_grid_id(oDB, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->grid_name, id_container_out, &id_grid) && id_grid){
		  //Check if ophidiadb dimensions are the same of input dimensions

		  //Read dimension
		  if(oph_odb_dim_retrieve_dimension_list_from_grid_in_container(oDB, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->grid_name, id_container_out, &dims, &dim_inst, &dim_inst_num)){
			pmesg(LOG_ERROR, __FILE__, __LINE__, "Input grid name not usable! It is already used by another container.\n");
			logging(LOG_ERROR, __FILE__, __LINE__, id_container_out, OPH_LOG_OPH_IMPORTNC_NO_GRID, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->grid_name );
			oph_dim_disconnect_from_dbms(db_dimension->dbms_instance);
			oph_dim_unload_dim_dbinstance(db_dimension);
			if(dims) free(dims);
		  ...
		  ***************************/
		  ...
		  for (i = 0; i < measure->ndims; i++){
			...
			if( j == number_of_dimensions_c){
				pmesg(LOG_ERROR, __FILE__, __LINE__, "Dimension %s not found for container %s\n", measure->dims_name[i], ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->container_input);
				logging(LOG_ERROR, __FILE__, __LINE__, id_container_out, OPH_LOG_OPH_IMPORTNC_DIM_CONT_ERROR, measure->dims_name[i], ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->container_input );
				free(tot_dims);
				free(dims);
				free(dim_inst);
				oph_dim_disconnect_from_dbms(db_dimension->dbms_instance);
		  ...
		  for (i = 0; i < measure->ndims; i++){
			...
			if(oph_nc_compare_nc_c_types(id_container_out, tmp_var.vartype, tot_dims[j].dimension_type)){
	...
	//Set fragment string
	char *tmp = id_string;
	if(oph_ids_create_new_id_string(&tmp,OPH_ODB_CUBE_FRAG_REL_INDEX_SET_SIZE,1,((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->total_frag_number)){
	...
	//Set datacube params
	cube.hostxdatacube = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->host_number;
	cube.dbmsxhost = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->dbmsxhost_number;
	cube.dbxdbms = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->dbxdbms_number;
	cube.fragmentxdb = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragxdb_number;
	...
	cube.level = 0;
	if (((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->description) snprintf(cube.description,OPH_ODB_CUBE_DESCRIPTION_SIZE,"%s",((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->description);
	...
	//If everything was ok insert cubehasdim relations
	  ...
	  if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->import_metadata){
		...
		if (((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->check_compliance) // Check if all the mandatory metadata are taken
		{
		...
		if (((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->create_container) // Check for time dimensions
		{
			for(i = 0; i < measure->ndims ; i++)
			{
	 ...
	 if( oph_odb_stge_retrieve_dbmsinstance_id_list(oDB, storage_type, ioserver_type, host_partition, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->host_number, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->dbmsxhost_number, &id_dbmss, &dbmss_length)){
    ...
    if(!((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->server){
      if(oph_dc2_setup_dbms(&(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->server), dbms.io_server_type))
	    {
		...
		if(oph_dc2_connect_to_dbms(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->server, &(dbms), 0))
		{
			...
			oph_dc2_disconnect_from_dbms(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->server, &(dbms));
			free(id_dbmss);
			goto __OPH_EXIT_1;
		}

		for(i = 0; i < ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->dbxdbms_number; i++){
		  ...
		  if(oph_dc2_create_db(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->server, &db)){
	...
	free(id_dbmss);
	  ...
	  id_datacube[2] = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->host_number;
	  id_datacube[3] = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->dbmsxhost_number;
	  id_datacube[4] = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->dbxdbms_number;
	  id_datacube[5] = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragxdb_number;
	  id_datacube[6] = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->tuplexfrag_number;
	  id_datacube[7] = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->total_frag_number;
...
__OPH_EXIT_1:
  ...
  {
	while (id_container_out && ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->create_container)
	{
		ophidiadb *oDB = &((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->oDB;
		...
		if(oph_odb_dim_delete_from_grid_table(oDB, id_container_out)){
			...
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_GRID_DELETE_ERROR );		
			break;
		}
		...
		if(oph_odb_fs_delete_from_container_table(oDB, id_container_out)){
			...
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_CONTAINER_DELETE_ERROR );		
			break;
		}
		...
		{
			pmesg(LOG_ERROR, __FILE__, __LINE__, "Error while loading dimension db paramters\n");
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_DIM_LOAD );
			oph_dim_unload_dim_dbinstance(db);		
			break;
		}
		if (oph_dim_connect_to_dbms(db->dbms_instance, 0))
		{
			pmesg(LOG_ERROR, __FILE__, __LINE__, "Error while connecting to dimension dbms\n");
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_DIM_CONNECT );
			oph_dim_disconnect_from_dbms(db->dbms_instance);
			oph_dim_unload_dim_dbinstance(db);
			break;
		}
		...
		{
			pmesg(LOG_ERROR, __FILE__, __LINE__, "Error while opening dimension db\n");
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_DIM_USE_DB );
			oph_dim_disconnect_from_dbms(db->dbms_instance);
			oph_dim_unload_dim_dbinstance(db);
			break;
		}
		...
		if (oph_dim_delete_table(db, index_dimension_table_name))
		{
			...
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_DIM_TABLE_DELETE_ERROR );
			oph_dim_disconnect_from_dbms(db->dbms_instance);
			oph_dim_unload_dim_dbinstance(db);	
			break;
		}
	...
	oph_odb_cube_delete_from_datacube_table(&((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->oDB, id_datacube_out);
  }
  ...
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_output_datacube = id_datacube[0];
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_input_container = id_datacube[1];
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->host_number = id_datacube[2];
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->dbmsxhost_number = id_datacube[3];
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->dbxdbms_number = id_datacube[4];
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragxdb_number = id_datacube[5];
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->tuplexfrag_number = id_datacube[6];
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->total_frag_number = id_datacube[7];
...
int task_distribute(oph_operator_struct *handle)
{
  if (!handle || !handle->operator_handle){
  	pmesg(LOG_ERROR, __FILE__, __LINE__, "Null Handle\n");
	logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_NULL_OPERATOR_HANDLE);
	  return OPH_ANALYTICS_OPERATOR_NULL_OPERATOR_HANDLE;
  }
  ...
  int frag_total_number = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->total_frag_number;
  ...
  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragment_number = div_result;

  if(div_remainder != 0)
  {
	//Only some certain processes must process an additional part
	if (handle->proc_rank/div_remainder == 0)
		((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragment_number++;
  }

  int i;
  //Compute fragment IDs starting position
  if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragment_number == 0){
	// In case number of process is higher than fragment number
    ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragment_first_id = -1;
  }
  else{
	((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragment_first_id = 0;
	for(i = handle->proc_rank-1; i >= 0; i--)
	{
		if(div_remainder != 0)
			((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragment_first_id += (div_result + (i/div_remainder == 0 ? 1 : 0) );
		else
			((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragment_first_id += div_result;
	}
	if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragment_first_id >= frag_total_number) ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragment_first_id = -1;
  }
...
int task_execute(oph_operator_struct *handle)
{
  ...
  if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragment_first_id < 0 && handle->proc_rank!= 0)
        return OPH_ANALYTICS_OPERATOR_SUCCESS;

  int i, j, k;
  int id_datacube_out = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_output_datacube;
  oph_odb_db_instance_list dbs;
  oph_odb_dbms_instance_list dbmss;

  //Compute DB list starting position and number of rows
  int start_position = (int)floor((double)((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragment_first_id/((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragxdb_number);
  int row_number = (int)ceil((double)(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragment_first_id + ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragment_number)/((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragxdb_number) - start_position;
	...
	if(oph_odb_read_ophidiadb_config_file(&oDB_slave)){
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Unable to read OphidiaDB configuration\n");
		logging(LOG_ERROR, __FILE__, __LINE__,((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_OPHIDIADB_CONFIGURATION_FILE, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->container_input );
	...
	if( oph_odb_connect_to_ophidiadb(&oDB_slave)){
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Unable to connect to OphidiaDB. Check access parameters.\n");
		logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_OPHIDIADB_CONNECTION_ERROR, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->container_input );
  ...
  if(oph_odb_stge_fetch_db_connection_string(&oDB_slave, id_datacube_out, start_position, row_number, &dbs, &dbmss)){
	...
	logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_CONNECTION_STRINGS_NOT_FOUND);
    oph_odb_free_ophidiadb(&oDB_slave);
	return OPH_ANALYTICS_OPERATOR_UTILITY_ERROR;
  }
  ...
  int frag_count = 0;
    ...
    if(!((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->server){
      if(oph_dc2_setup_dbms(&(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->server), dbmss.value[0].io_server_type))
	    {
		    pmesg(LOG_ERROR, __FILE__, __LINE__, "Unable to initialize IO server.\n");
		    logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_IOPLUGIN_SETUP_ERROR,dbmss.value[0].id_dbms);		 
  ...
  for(i = 0; i < dbmss.size; i++){
	...
	if(oph_dc2_connect_to_dbms(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->server, &(dbmss.value[i]), 0))
	{
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Unable to connect to DBMS. Check access parameters.\n");
		logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_DBMS_CONNECTION_ERROR, (dbmss.value[i]).id_dbms);
	    oph_dc2_disconnect_from_dbms(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->server, &(dbmss.value[i]));
		oph_odb_stge_free_db_list(&dbs);
		oph_odb_stge_free_dbms_list(&dbmss);
	    oph_odb_free_ophidiadb(&oDB_slave);
	    return OPH_ANALYTICS_OPERATOR_MYSQL_ERROR;
	...
	for(j = 0; j < dbs.size; j++){
		...
		if(oph_dc2_use_db_of_dbms(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->server, &(dbmss.value[i]), &(dbs.value[j])))
		{
			pmesg(LOG_ERROR, __FILE__, __LINE__, "Unable to use the DB. Check access parameters.\n");
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_DB_SELECTION_ERROR, (dbs.value[j]).db_name);
			oph_dc2_disconnect_from_dbms(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->server, &(dbmss.value[i]));
			oph_odb_stge_free_db_list(&dbs);
			oph_odb_stge_free_dbms_list(&dbmss);
		    oph_odb_free_ophidiadb(&oDB_slave);
		...
		frag_to_insert = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragxdb_number - (((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragment_first_id + frag_count - start_position*((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragxdb_number);
		...
		for(k = 0; k < frag_to_insert; k++){
			...
			new_frag.frag_relative_index = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragment_first_id + frag_count + 1;
			new_frag.key_start = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragment_first_id * ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->tuplexfrag_number + frag_count* ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->tuplexfrag_number + 1;
			new_frag.key_end = ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragment_first_id * ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->tuplexfrag_number + frag_count* ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->tuplexfrag_number + ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->tuplexfrag_number;
			...
			if(oph_dc2_generate_fragment_name(NULL, id_datacube_out, handle->proc_rank, (frag_count+1), &(new_frag.fragment_name)))
			{
				...
				logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_STRING_BUFFER_OVERFLOW, "fragment name", new_frag.fragment_name);
				oph_dc2_disconnect_from_dbms(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->server, &(dbmss.value[i]));
				oph_odb_stge_free_db_list(&dbs);
				oph_odb_stge_free_dbms_list(&dbmss);
			    oph_odb_free_ophidiadb(&oDB_slave);
			...
			if (oph_dc2_create_empty_fragment(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->server, &new_frag))
			{
				pmesg(LOG_ERROR, __FILE__, __LINE__, "Error while creating fragment.\n");
				logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_FRAGMENT_CREATION_ERROR, new_frag.fragment_name);
				oph_dc2_disconnect_from_dbms(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->server, &(dbmss.value[i]));
				oph_odb_stge_free_db_list(&dbs);
				oph_odb_stge_free_dbms_list(&dbmss);
			    oph_odb_free_ophidiadb(&oDB_slave);
			...
			//Populate fragment
			if(oph_nc_populate_fragment_from_nc3(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->server, &new_frag, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->ncid, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->tuplexfrag_number, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->array_length, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->compressed, (NETCDF_var*)&(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->measure), ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->memory_size)){
				pmesg(LOG_ERROR, __FILE__, __LINE__, "Error while populating fragment.\n");
				logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_FRAG_POPULATE_ERROR, new_frag.fragment_name, "");
				oph_dc2_disconnect_from_dbms(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->server, &(dbmss.value[i]));
				oph_odb_stge_free_db_list(&dbs);
				oph_odb_stge_free_dbms_list(&dbmss);
			    oph_odb_free_ophidiadb(&oDB_slave);
			...
			if(oph_odb_stge_insert_into_fragment_table(&oDB_slave, &new_frag)){
				...
				logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_FRAGMENT_INSERT_ERROR, new_frag.fragment_name);
				oph_dc2_disconnect_from_dbms(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->server, &(dbmss.value[i]));
				oph_odb_stge_free_db_list(&dbs);
				oph_odb_stge_free_dbms_list(&dbmss);
			    oph_odb_free_ophidiadb(&oDB_slave);
			...
			frag_count++;
			if( frag_count == ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->fragment_number) break;
		}
		start_position++;
	}
	oph_dc2_disconnect_from_dbms(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->server, &(dbmss.value[i]));
  ...
  if(handle->proc_rank == 0)
  {
	...
	if (oph_pid_get_uri(&tmp_uri) ){
		...
		logging(LOG_WARNING, __FILE__, __LINE__, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_PID_URI_ERROR );
		return OPH_ANALYTICS_OPERATOR_UTILITY_ERROR;
	}
	if(oph_pid_show_pid(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_input_container, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_output_datacube, tmp_uri)){
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Unable to print PID string\n");
		logging(LOG_WARNING, __FILE__, __LINE__, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_PID_SHOW_ERROR );
		free(tmp_uri);
		return OPH_ANALYTICS_OPERATOR_UTILITY_ERROR;
	}
	char jsonbuf[OPH_COMMON_BUFFER_LEN];
	memset(jsonbuf,0,OPH_COMMON_BUFFER_LEN);
	snprintf(jsonbuf,OPH_COMMON_BUFFER_LEN, OPH_PID_FORMAT, tmp_uri, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_input_container, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_output_datacube);	
...
int env_unset(oph_operator_struct *handle)
{
  ...
  if(handle->proc_rank == 0){
	  oph_odb_free_ophidiadb(&((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->oDB);
  }
  if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->container_input){
	  free((char *)((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->container_input);
	  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->container_input = NULL;
  }
  if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->cwd){
	  free((char *)((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->cwd);
	  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->cwd = NULL;
  }

  if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->server) oph_dc2_cleanup_dbms(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->server);


  if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->ioserver_type){
	  free((char *)((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->ioserver_type); 
	  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->ioserver_type = NULL;
  }

  if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->user){
	  free((char *)((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->user);
	  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->user = NULL;
  }
  if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->grid_name){
	  free((char *)((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->grid_name);
	  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->grid_name = NULL;
  }
  if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->nc_file_path){
	  free((char *)((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->nc_file_path);
	  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->nc_file_path = NULL;
  }
  ...
  if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->partition_input){
	  free((char *)((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->partition_input);
	  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->partition_input = NULL;
  }
  if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_dimension_hierarchy){
	  free((int*)((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_dimension_hierarchy);
	  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->id_dimension_hierarchy = NULL;
  }
  if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->objkeys){
      oph_tp_free_multiple_value_param_list(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->objkeys, ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->objkeys_num);
      ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->objkeys = NULL;
  }
  if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->sessionid){
 	  free((char *)((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->sessionid);
 	  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->sessionid = NULL;
  }
  if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->base_time){
	  free((char*)((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->base_time);
	  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->base_time = NULL;
  }
  if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->units){
	  free((char*)((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->units);
	  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->units = NULL;
  }
  if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->calendar){
	  free((char*)((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->calendar);
	  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->calendar = NULL;
  }
  if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->month_lengths){
	  free((char*)((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->month_lengths);
	  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->month_lengths = NULL;
  }
  if(((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->description){
	  free((char *)((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->description);
	  ((OPH_IMPORTNC3_operator_handle*)handle->operator_handle)->description = NULL;
  }

  free((OPH_IMPORTNC3_operator_handle*)handle->operator_handle);
