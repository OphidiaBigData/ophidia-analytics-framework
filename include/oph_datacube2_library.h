...
#ifndef __OPH_DATACUBE2_H__
#define __OPH_DATACUBE2_H__
...
#define OPH_DC2_SUCCESS 0
#define OPH_DC2_NULL_PARAM 1
#define OPH_DC2_SERVER_ERROR 2
#define OPH_DC2_DATA_ERROR 3

#define OPH_DC2_DOUBLE_TYPE OPH_COMMON_DOUBLE_TYPE
#define OPH_DC2_FLOAT_TYPE OPH_COMMON_FLOAT_TYPE
#define OPH_DC2_INT_TYPE OPH_COMMON_INT_TYPE
#define OPH_DC2_LONG_TYPE OPH_COMMON_LONG_TYPE
#define OPH_DC2_SHORT_TYPE OPH_COMMON_SHORT_TYPE
#define OPH_DC2_BYTE_TYPE OPH_COMMON_BYTE_TYPE
#define OPH_DC2_BIT_TYPE OPH_COMMON_BIT_TYPE

#define OPH_DC2_DOUBLE_FLAG OPH_COMMON_DOUBLE_FLAG
#define OPH_DC2_FLOAT_FLAG OPH_COMMON_FLOAT_FLAG
#define OPH_DC2_INT_FLAG OPH_COMMON_INT_FLAG
#define OPH_DC2_LONG_FLAG OPH_COMMON_LONG_FLAG
#define OPH_DC2_SHORT_FLAG OPH_COMMON_SHORT_FLAG
#define OPH_DC2_BYTE_FLAG OPH_COMMON_BYTE_FLAG
#define OPH_DC2_BIT_FLAG OPH_COMMON_BIT_FLAG

#define OPH_DC2_DB_NAME "db_%s_%d_%d_%d_%d"
#define OPH_DC2_FRAG_NAME "fact_%d_%d_%d"
#define OPH_DC2_DB_FRAG_NAME "%s.fact_%d_%d_%d"
 ...
 * \return 0 if successfull, -1 otherwise
 */
int oph_dc2_use_db_of_dbms(oph_ioserver_handler * server, oph_odb_dbms_instance * m1, oph_odb_db_instance * m2);
 ...
 * \return 0 if successfull, -1 otherwise
 */
int oph_dc2_check_connection_to_db(oph_ioserver_handler * server, oph_odb_dbms_instance * m1, oph_odb_db_instance * m2, unsigned long flag);
 ...
 * \return 0 if successfull, -1 otherwise
 */
int oph_dc2_disconnect_from_dbms(oph_ioserver_handler * server, oph_odb_dbms_instance * m);
 ...
 */
int oph_dc2_create_db(oph_ioserver_handler * server, oph_odb_db_instance * m);
 ...
 * \return 0 if successfull, N otherwise
 */
int oph_dc2_delete_db(oph_ioserver_handler * server, oph_odb_db_instance * m);
 ...
 * \return 0 if successfull, N otherwise
 */
int oph_dc2_populate_fragment_with_rand_data(oph_ioserver_handler * server, oph_odb_fragment * m, int tuple_number, int array_length, char *data_type, int compressed);
 ...
 * \return 0 if successfull, N otherwise
 */
int oph_dc2_delete_fragment(oph_ioserver_handler * server, oph_odb_fragment * m);
