...
#include "drivers/OPH_IMPORTNC6_operator.h"
...
int env_set(HASHTBL * task_tbl, oph_operator_struct * handle)
{
	...
	if (!(handle->operator_handle = (OPH_IMPORTNC6_operator_handle *) calloc(1, sizeof(OPH_IMPORTNC6_operator_handle)))) {
	...
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nthread = 0;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->container_input = NULL;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->create_container = 0;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->user = NULL;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->grid_name = NULL;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->check_grid = 0;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nc_file_path = NULL;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nc_file_path_orig = NULL;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_output_datacube = 0;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_input_container = 0;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->compressed = 0;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->import_metadata = 0;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->check_compliance = 0;
	NETCDF_var *nc_measure = &(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->measure);
	...
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->cwd = NULL;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->user = NULL;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->run = 1;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->objkeys = NULL;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->objkeys_num = -1;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fs_type = 0;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->ioserver_type = NULL;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->server = NULL;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->sessionid = NULL;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_dimension_hierarchy = NULL;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_vocabulary = 0;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->base_time = NULL;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->units = NULL;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->calendar = NULL;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->month_lengths = NULL;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->leap_year = 0;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->leap_month = 2;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->memory_size = 0;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->description = NULL;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->time_filter = 1;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->tuplexfrag_number = 1;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->execute_error = 0;
	...
	if (oph_tp_parse_multiple_value_param(value, &((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->objkeys, &((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->objkeys_num)) {
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Operator string not valid\n");
		logging(LOG_ERROR, __FILE__, __LINE__, OPH_GENERIC_CONTAINER_ID, "Operator string not valid\n");
		oph_tp_free_multiple_value_param_list(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->objkeys, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->objkeys_num);
		return OPH_ANALYTICS_OPERATOR_INVALID_PARAM;
	}
	// retrieve sessionid
	...
	if (!(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->sessionid = (char *) strndup(value, OPH_TP_TASKLEN))) {
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
	...
	if (!(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->base_time = (char *) strndup(value, OPH_TP_TASKLEN))) {
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
	...
	if (!(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->units = (char *) strndup(value, OPH_TP_TASKLEN))) {
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
	...
	if (!(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->calendar = (char *) strndup(value, OPH_TP_TASKLEN))) {
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
	...
	if (!(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->month_lengths = (char *) strndup(value, OPH_TP_TASKLEN))) {
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
	...
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->leap_year = (int) strtol(value, NULL, 10);
	...
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->leap_month = (int) strtol(value, NULL, 10);
	...
	if (strncmp(value, OPH_COMMON_DEFAULT_EMPTY_VALUE, OPH_TP_TASKLEN)) {
		if (!(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->description = (char *) strndup(value, OPH_TP_TASKLEN))) {
	...
	if (value && !strcmp(value, OPH_COMMON_NO_VALUE))
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->time_filter = 0;
	...
	if (strncmp(value, OPH_COMMON_YES_VALUE, OPH_TP_TASKLEN) == 0) {
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->import_metadata = 1;
	}
	...
	if (!(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nc_file_path = (char *) strndup(value, OPH_TP_TASKLEN))) {
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
	...
	if (!(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nc_file_path_orig = strdup(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nc_file_path))) {
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
	...
	if (!strncmp(value, OPH_COMMON_DEFAULT_EMPTY_VALUE, OPH_TP_TASKLEN)) {
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->create_container = 1;
		char *pointer = strrchr(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nc_file_path, '/');
		while (pointer && !strlen(pointer)) {
			*pointer = 0;
			pointer = strrchr(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nc_file_path, '/');
		}
		container_name = pointer ? pointer + 1 : ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nc_file_path;
	} else
		container_name = value;
	if (!(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->container_input = (char *) strndup(container_name, OPH_TP_TASKLEN))) {
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
	...
	if (!(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->user = (char *) strndup(value, OPH_TP_TASKLEN))) {
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
	...
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nthread = (unsigned int) strtol(value, NULL, 10);

	if (strstr(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nc_file_path, "..")) {
	...
	if (!strstr(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nc_file_path, "http://")
	    && !strstr(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nc_file_path, "https://")) {
		char *pointer = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nc_file_path;
		...
		if (pointer) {
			...
			if (*pointer != '/') {
				...
				if (strlen(value) > 1) {
					...
					free(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nc_file_path);
					((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nc_file_path = strdup(tmp);
					pointer = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nc_file_path;
				}
			}
	...
	if (oph_pid_get_memory_size(&(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->memory_size))) {
	...
	if (!(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->cwd = (char *) strndup(value, OPH_TP_TASKLEN))) {
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
	...
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->schedule_algo = (int) strtol(value, NULL, 10);
	...
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->host_number = (int) strtol(value, NULL, 10);
	if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->host_number == 0)
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->host_number = -1;	// All the host of the partition
	...
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->dbmsxhost_number = (int) strtol(value, NULL, 10);
	if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->dbmsxhost_number == 0)
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->dbmsxhost_number = -1;	// All the DBMS of the host
	...
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->dbxdbms_number = (int) strtol(value, NULL, 10);	// 'All by means of special value 0' is not defined in this case
	...
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragxdb_number = (int) strtol(value, NULL, 10);
	if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragxdb_number == 0)
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragxdb_number = -1;	// The maximum number of fragments

	//Additional check (all distrib arguments must be bigger than 0 or at least -1 if default values are given)
	if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->host_number == 0 || ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->dbmsxhost_number == 0
	    || ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->dbxdbms_number == 0 || ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragxdb_number == 0) {
	...
	NETCDF_var *measure = ((NETCDF_var *) & (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->measure));
	...
	//Open netcdf file
	int retval, j = 0;
	if ((retval = nc_open(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nc_file_path, NC_NOWRITE, &(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->ncid)))) {
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Unable to open netcdf file '%s': %s\n", ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nc_file_path, nc_strerror(retval));
	...
	int ncid = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->ncid;
	...
	if (ndims) {
		...
		if (strncmp(value, OPH_IMPORTNC6_DIMENSION_DEFAULT, strlen(value)) || strncmp(value, OPH_IMPORTNC6_DIMENSION_DEFAULT, strlen(OPH_IMPORTNC6_DIMENSION_DEFAULT))) {
	...
	for (i = 0; i < number_of_sub_dims; i++) {
		if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->time_filter && strchr(sub_filters[i], OPH_DIM_SUBSET_SEPARATOR[1])) {
			if (tf >= 0) {
	...
	if (handle->proc_rank == 0) {
		...
		ophidiadb *oDB = &((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->oDB;
		...
		if (strncmp(value, OPH_COMMON_DEFAULT_EMPTY_VALUE, OPH_TP_TASKLEN)) {
			if ((oph_odb_meta_retrieve_vocabulary_id(oDB, value, &((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_vocabulary))) {
	...
	if (tf >= 0) {
		...
		if (handle->proc_rank == 0) {
			...
			char *cwd = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->cwd;
			char *user = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->user;
			...
			if ((oph_odb_fs_check_folder_session(folder_id, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->sessionid, oDB, &permission)) || !permission) {
				//Check if user can work on datacube
		...
		int create_container = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->create_container;
		if (container_exists)
			create_container = 0;

		if (create_container) {
			if (!((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->import_metadata || !handle->proc_rank) {
				strncpy(dim.base_time, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->base_time, OPH_ODB_DIM_TIME_SIZE);
				dim.base_time[OPH_ODB_DIM_TIME_SIZE] = 0;
				dim.leap_year = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->leap_year;
				dim.leap_month = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->leap_month;
				...
				j = 0;
				strncpy(dim.units, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->units, OPH_ODB_DIM_TIME_SIZE);
				dim.units[OPH_ODB_DIM_TIME_SIZE] = 0;
				strncpy(dim.calendar, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->calendar, OPH_ODB_DIM_TIME_SIZE);
				dim.calendar[OPH_ODB_DIM_TIME_SIZE] = 0;
				char *tmp = NULL, *save_pointer = NULL, month_lengths[1 + OPH_ODB_DIM_TIME_SIZE];
				strncpy(month_lengths, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->month_lengths, OPH_ODB_DIM_TIME_SIZE);
			...
			if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->import_metadata) {
				...
				if (handle->proc_rank == 0) {
					...
					if (update_dim_with_nc_metadata(oDB, time_dim, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_vocabulary, OPH_GENERIC_CONTAINER_ID, ncid))
			...
			if (handle->proc_rank == 0) {
				...
				while (flag) {
					...
					if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->import_metadata) {
						...
						if (!((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_vocabulary
						    && oph_odb_meta_retrieve_vocabulary_id_from_container(oDB, id_container_out,
													  &((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_vocabulary)) {
						...
						if (update_dim_with_nc_metadata(oDB, time_dim, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_vocabulary, id_container_out, ncid))
							break;
					}
	...
	if (number_of_sub_dims) {
		for (i = 0; i < number_of_sub_types; ++i)
			is_index[i] = strncmp(sub_types[i], OPH_IMPORTNC6_SUBSET_COORD, OPH_TP_TASKLEN);
	...
	if (strncmp(value, OPH_COMMON_YES_VALUE, OPH_TP_TASKLEN) == 0) {
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->compressed = 1;
	}
	...
	if (strncmp(value, OPH_COMMON_NO_VALUE, OPH_TP_TASKLEN) == 0) {
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->run = 0;
	}
	...
	if (strncmp(value, OPH_COMMON_YES_VALUE, OPH_TP_TASKLEN) == 0) {
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->check_compliance = 1;
	}
	...
	if (!(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->partition_input = (char *) strndup(value, OPH_TP_TASKLEN))) {
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
	...
	if (strncmp(value, OPH_COMMON_IO_FS_GLOBAL, OPH_TP_TASKLEN) == 0) {
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fs_type = OPH_COMMON_IO_FS_GLOBAL_TYPE;
	} else if (strncmp(value, OPH_COMMON_IO_FS_LOCAL, OPH_TP_TASKLEN) == 0) {
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fs_type = OPH_COMMON_IO_FS_LOCAL_TYPE;
	} else {
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fs_type = OPH_COMMON_IO_FS_DEFAULT_TYPE;
	}
	...
	if (!(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->ioserver_type = (char *) strndup(value, OPH_TP_TASKLEN))) {
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
	...
	if (strcasecmp(value, OPH_COMMON_DEFAULT_GRID) != 0) {
		if (!(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->grid_name = (char *) strndup(value, OPH_TP_TASKLEN))) {
			pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
	...
	if (!strncmp(value, OPH_COMMON_YES_VALUE, OPH_TP_TASKLEN))
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->check_grid = 1;
	...
	if (handle->proc_rank == 0) {
		...
		if (strncmp(value, OPH_COMMON_DEFAULT_HIERARCHY, strlen(value)) || strncmp(value, OPH_COMMON_DEFAULT_HIERARCHY, strlen(OPH_COMMON_DEFAULT_HIERARCHY))) {
			...
			if (!(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_dimension_hierarchy = (int *) malloc(number_of_dimensions_hierarchy * sizeof(int)))) {
				pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
			...
			memset(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_dimension_hierarchy, 0, number_of_dimensions_hierarchy * sizeof(int));
			...
			for (i = 0; i < number_of_dimensions_hierarchy; i++) {
				...
				((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_dimension_hierarchy[m2u[i]] = id_hierarchy;
				if (!strcasecmp(dim_hierarchy[i], OPH_COMMON_TIME_HIERARCHY)) {
					...
					((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_dimension_hierarchy[m2u[i]] *= -1;
					found_oph_time = 1;
				}
			}
			oph_tp_free_multiple_value_param_list(dim_hierarchy, number_of_dimensions_hierarchy);
		...
		//Default hierarchy
			...
			if (!(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_dimension_hierarchy = (int *) malloc(measure->ndims * sizeof(int)))) {
				pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
				logging(LOG_ERROR, __FILE__, __LINE__, OPH_GENERIC_CONTAINER_ID, OPH_LOG_OPH_IMPORTNC_MEMORY_ERROR_INPUT_NO_CONTAINER, container_name, "id dimension hierarchy");
				return OPH_ANALYTICS_OPERATOR_MEMORY_ERR;
			}
			memset(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_dimension_hierarchy, 0, measure->ndims * sizeof(int));
			...
			for (i = 0; i < measure->ndims; i++)
				((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_dimension_hierarchy[i] = id_hierarchy;
		}
	}

	value = hashtbl_get(task_tbl, OPH_ARG_IDJOB);
	if (!value)
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_job = 0;
	else
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_job = (int) strtol(value, NULL, 10);
...
int task_init(oph_operator_struct * handle)
{
	if (!handle || !handle->operator_handle) {
		...
		logging(LOG_ERROR, __FILE__, __LINE__, OPH_GENERIC_CONTAINER_ID, OPH_LOG_OPH_IMPORTNC_NULL_OPERATOR_HANDLE_NO_CONTAINER,
			((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->container_input);
		return OPH_ANALYTICS_OPERATOR_NULL_OPERATOR_HANDLE;
	}
	//For error checking
	...
	NETCDF_var *measure = &((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->measure;
	...
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->tuplexfrag_number = 1;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->array_length = 1;
	for (i = 0; i < measure->ndims; i++) {
		if (measure->dims_type[i]) {
			...
			if(measure->dims_oph_level[i] == min_lev){
				...
				((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->total_frag_number = measure->dims_end_index[i] - measure->dims_start_index[i] + 1;
				...
				((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->tuplexfrag_number *= (measure->dims_end_index[i] - measure->dims_start_index[i]) + 1;
			}
		} else {
			//Consider only implicit dimensions
			((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->array_length *= (measure->dims_end_index[i] - measure->dims_start_index[i]) + 1;
		}
	}

	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->number_unven_frag = 0;
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->int_dim_product = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->tuplexfrag_number;

	int container_exists = 0;
	char *container_name = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->container_input;
	int create_container = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->create_container;
	...
	if (handle->proc_rank == 0) {
		...
		int *host_number = &((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->host_number;
		int *dbmsxhost_number = &((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->dbmsxhost_number;
		int *dbxdbms_number = &((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->dbxdbms_number;
		int *fragxdb_number = &((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragxdb_number;
		int storage_type = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fs_type;
		char *host_partition = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->partition_input;
		char *ioserver_type = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->ioserver_type;
		int run = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->run;
	   ...
	   ********************************/
		...
		int final_frag_number = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->total_frag_number;

		int max_frag_number = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->total_frag_number * ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->tuplexfrag_number;
		...
		if ((!strncmp(host_partition, OPH_COMMON_HOSTPARTITION_DEFAULT, strlen(host_partition))
			...
			if (oph_odb_stge_get_default_host_partition_fs
			    (oDB, &((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fs_type, ioserver_type, &((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->partition_input,
				...
				if (run) {
					...
					logging(LOG_ERROR, __FILE__, __LINE__, OPH_GENERIC_CONTAINER_ID, OPH_LOG_OPH_IMPORTNC_HOST_DBMS_CONSTRAINT_FAILED_NO_CONTAINER, container_name,
						((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->host_number, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->dbmsxhost_number,
						host_partition);
					goto __OPH_EXIT_1;
				} else {
			...
			host_partition = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->partition_input;
			storage_type = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fs_type;
			...
			if (*host_number > 0 || *dbmsxhost_number > 0) {
				if ((oph_odb_stge_check_number_of_host_dbms(oDB, storage_type, ioserver_type, host_partition, (*host_number > 0 ? *host_number : 1), *dbmsxhost_number, &exist_part))
					...
					if (run) {
						pmesg(LOG_ERROR, __FILE__, __LINE__, "Requested number of hosts or dbms per host is too big or server type and partition are not available!\n");
						logging(LOG_ERROR, __FILE__, __LINE__, OPH_GENERIC_CONTAINER_ID, OPH_LOG_OPH_IMPORTNC_HOST_DBMS_CONSTRAINT_FAILED_NO_CONTAINER, container_name,
							((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->host_number,
							((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->dbmsxhost_number, host_partition);
						goto __OPH_EXIT_1;
					} else {
						//If simulated run then reset values
						pmesg(LOG_ERROR, __FILE__, __LINE__, "Requested number of hosts or dbms per host is too big or server type and partition are not available!\n");
			...
			if (*host_number <= 0) {
						...
						if (final_frag_number % user_arg_prod != 0) {
							...
							if (admissible_frag_number <= nhost) {
								...
								*host_number = ii;
								...
								((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->tuplexfrag_number =
								    (int) ceilf((float) max_frag_number / ((*host_number) * user_arg_prod));
								((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->number_unven_frag = max_frag_number % ((*host_number) * user_arg_prod);
								((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->total_frag_number =
				...
				if (*fragxdb_number <= 0) {
					...
					if (final_frag_number < user_arg_prod) {
						...
						//Since fragxdb is fixed recompute tuplexfrag
						((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->tuplexfrag_number *= (int) ceilf((float) final_frag_number / user_arg_prod);
						((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->number_unven_frag = final_frag_number % (user_arg_prod);
						((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->total_frag_number =
						    ((*host_number) * (*dbmsxhost_number) * (*dbxdbms_number) * (*fragxdb_number));
					}
				}
		...
		if (frag_param_error) {
			...
			int ii = 0;
			for (ii = nhost; ii > 0; ii--) {
				if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->total_frag_number % ii == 0)
					break;
			}
		...
		if (!((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->run) {
			...
			len += snprintf(message + len, OPH_COMMON_BUFFER_LEN, "\tNumber of fragments per database: %d\n", ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragxdb_number);
			len += snprintf(message + len, OPH_COMMON_BUFFER_LEN, "\tNumber of tuples per fragment: %d\n", ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->tuplexfrag_number);

			if (oph_json_is_objkey_printable
			    (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->objkeys, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->objkeys_num,
				...
				if (oph_json_add_text(handle->operator_json, OPH_JSON_OBJKEY_IMPORTNC, "Fragmentation parameters", message)) {
					...
					logging(LOG_WARNING, __FILE__, __LINE__, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_input_container, "ADD TEXT error\n");
				}
			}
			goto __OPH_EXIT_1;
		}
		...
		if (create_container) {
			...
			cont.operation[0] = 0;
			cont.id_vocabulary = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_vocabulary;
			...
			((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_input_container = id_container_out;
			...
			for (i = 0; i < measure->ndims; i++) {
				...
				dim.id_hierarchy = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_dimension_hierarchy[i];
		...
		if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->import_metadata) {
			if (!((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_vocabulary
			    && oph_odb_meta_retrieve_vocabulary_id_from_container(oDB, id_container_out, &((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_vocabulary)) {
				pmesg(LOG_ERROR, __FILE__, __LINE__, "Unknown vocabulary\n");
				logging(LOG_ERROR, __FILE__, __LINE__, OPH_GENERIC_CONTAINER_ID, OPH_LOG_OPH_IMPORTNC_NO_VOCABULARY_NO_CONTAINER, container_name, "");
				goto __OPH_EXIT_1;
			}
		...
		if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->grid_name
		    && !oph_odb_dim_retrieve_grid_id(oDB, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->grid_name, id_container_out, &id_grid) && id_grid) {
			...
			if (oph_odb_dim_retrieve_dimension_list_from_grid_in_container
			    (oDB, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->grid_name, id_container_out, &dims, &dim_inst, &dim_inst_num)) {
				pmesg(LOG_ERROR, __FILE__, __LINE__, "Input grid name not usable! It is already used by another container.\n");
				logging(LOG_ERROR, __FILE__, __LINE__, id_container_out, OPH_LOG_OPH_IMPORTNC_NO_GRID, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->grid_name);
				oph_dim_disconnect_from_dbms(db_dimension->dbms_instance);
				oph_dim_unload_dim_dbinstance(db_dimension);
				if (dims)
					free(dims);
				...
				for (j = 0; j < dim_inst_num; j++) {
					if (!strncmp(dims[j].dimension_name, measure->dims_name[i], OPH_ODB_DIM_DIMENSION_SIZE)) {
						...
						if (dim_inst[j].size == curdimlength && dim_inst[j].concept_level == measure->dims_concept_level[i]) {
							...
							if (!((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->check_grid || (!oph_dim_compare_dimension
		  ...
		  ***************************/
			...
			for (i = 0; i < measure->ndims; i++) {
				...
				if (!exists) {
					if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->import_metadata && (time_dimension < 0)
			...
			if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->grid_name) {
				strncpy(new_grid.grid_name, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->grid_name, OPH_ODB_DIM_GRID_SIZE);
	   ...
	   ********************************/
		//Set fragment string
		char *tmp = id_string;
		if (oph_ids_create_new_id_string(&tmp, OPH_ODB_CUBE_FRAG_REL_INDEX_SET_SIZE, 1, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->total_frag_number)) {
		...
		oph_odb_source src;
		int id_src = 0;
		strncpy(src.uri, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nc_file_path_orig, OPH_ODB_CUBE_SOURCE_URI_SIZE);
		...
		//Set datacube params
		cube.hostxdatacube = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->host_number;
		cube.dbmsxhost = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->dbmsxhost_number;
		cube.dbxdbms = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->dbxdbms_number;
		cube.fragmentxdb = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragxdb_number;
		cube.tuplexfragment = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->tuplexfrag_number;
		cube.id_container = id_container_out;
		strncpy(cube.measure, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->measure.varname, OPH_ODB_CUBE_MEASURE_SIZE);
		cube.measure[OPH_ODB_CUBE_MEASURE_SIZE] = 0;
		if (oph_nc_get_c_type(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->measure.vartype, cube.measure_type)) {
		...
		cube.compressed = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->compressed;
		cube.id_db = NULL;
		//New fields
		cube.id_source = id_src;
		cube.level = 0;
		if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->description)
			snprintf(cube.description, OPH_ODB_CUBE_DESCRIPTION_SIZE, "%s", ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->description);
		else
			*cube.description = 0;
	   ...
	   ********************************/
		if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->import_metadata) {
			...
			//Retrieve user id
			char *username = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->user;
			int id_user = 0;
			...
			MYSQL_RES *key_list = NULL;
			int num_rows = 0;
			if (oph_odb_meta_find_metadatakey_list(oDB, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_vocabulary, &key_list)) {
			...
			if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->check_compliance)	// Check if all the mandatory metadata are taken
			{
	   ...
	   ********************************/
		...
		if (oph_odb_stge_retrieve_dbmsinstance_id_list
		    (oDB, storage_type, ioserver_type, host_partition, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->host_number,
		     ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->dbmsxhost_number, &id_dbmss, &dbmss_length)) {
		...
		for (j = 0; j < dbmss_length; j++) {
			...
			if (!((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->server) {
				if (oph_dc_setup_dbms(&(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->server), dbms.io_server_type)) {
			...
			if (oph_dc_connect_to_dbms(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->server, &(dbms), 0)) {
				...
				oph_dc_disconnect_from_dbms(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->server, &(dbms));
				free(id_dbmss);
				goto __OPH_EXIT_1;
			}

			for (i = 0; i < ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->dbxdbms_number; i++) {
				...
				if (oph_dc_create_db(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->server, &db)) {
	   ...
	   ********************************/
		...
		new_task.id_job = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_job;
		...
		if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->compressed)
		...
		id_datacube[2] = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->host_number;
		id_datacube[3] = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->dbmsxhost_number;
		id_datacube[4] = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->dbxdbms_number;
		id_datacube[5] = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragxdb_number;
		id_datacube[6] = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->tuplexfrag_number;
		id_datacube[7] = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->total_frag_number;
		id_datacube[8] = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->number_unven_frag;
	...
	if (!handle->proc_rank && flush) {
		while (id_container_out && create_container) {
			...
			if (oph_odb_dim_delete_from_grid_table(oDB, id_container_out)) {
				...
				logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_GRID_DELETE_ERROR);
				break;
			}
			...
			if (oph_odb_fs_delete_from_container_table(oDB, id_container_out)) {
				...
				logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_CONTAINER_DELETE_ERROR);
				break;
			}
			...
			if (oph_dim_load_dim_dbinstance(db)) {
				pmesg(LOG_ERROR, __FILE__, __LINE__, "Error while loading dimension db paramters\n");
				logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_DIM_LOAD);
				oph_dim_unload_dim_dbinstance(db);
				break;
			}
			if (oph_dim_connect_to_dbms(db->dbms_instance, 0)) {
				pmesg(LOG_ERROR, __FILE__, __LINE__, "Error while connecting to dimension dbms\n");
				logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_DIM_CONNECT);
				oph_dim_disconnect_from_dbms(db->dbms_instance);
				oph_dim_unload_dim_dbinstance(db);
				break;
			}
			if (oph_dim_use_db_of_dbms(db->dbms_instance, db)) {
				pmesg(LOG_ERROR, __FILE__, __LINE__, "Error while opening dimension db\n");
				logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_DIM_USE_DB);
				oph_dim_disconnect_from_dbms(db->dbms_instance);
				oph_dim_unload_dim_dbinstance(db);
				break;
			}
			...
			if (oph_dim_delete_table(db, index_dimension_table_name)) {
				...
				logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_DIM_TABLE_DELETE_ERROR);
				oph_dim_disconnect_from_dbms(db->dbms_instance);
				oph_dim_unload_dim_dbinstance(db);
				break;
			}
		...
		oph_odb_cube_delete_from_datacube_table(&((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->oDB, id_datacube_out);
	}
	...
	if (!id_datacube[0] || !id_datacube[1]) {
		...
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->execute_error = 1;
		return OPH_ANALYTICS_OPERATOR_UTILITY_ERROR;
	}
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_output_datacube = id_datacube[0];
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_input_container = id_datacube[1];
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->host_number = id_datacube[2];
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->dbmsxhost_number = id_datacube[3];
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->dbxdbms_number = id_datacube[4];
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragxdb_number = id_datacube[5];
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->tuplexfrag_number = id_datacube[6];
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->total_frag_number = id_datacube[7];
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->number_unven_frag = id_datacube[8];
...
int task_distribute(oph_operator_struct * handle)
{
	if (!handle || !handle->operator_handle) {
		pmesg(LOG_ERROR, __FILE__, __LINE__, "Null Handle\n");
		logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_NULL_OPERATOR_HANDLE);
		return OPH_ANALYTICS_OPERATOR_NULL_OPERATOR_HANDLE;
	}
	...
	int frag_total_number = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->total_frag_number;
	...
	((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragment_number = div_result;

	if (div_remainder != 0) {
		//Only some certain processes must process an additional part
		if (handle->proc_rank / div_remainder == 0)
			((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragment_number++;
	}

	int i;
	//Compute fragment IDs starting position
	if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragment_number == 0) {
		// In case number of process is higher than fragment number
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragment_first_id = -1;
	} else {
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragment_first_id = 0;
		for (i = handle->proc_rank - 1; i >= 0; i--) {
			if (div_remainder != 0)
				((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragment_first_id += (div_result + (i / div_remainder == 0 ? 1 : 0));
			else
				((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragment_first_id += div_result;
		}
		if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragment_first_id >= frag_total_number)
			((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragment_first_id = -1;
	}
...
int task_execute(oph_operator_struct * handle)
{
	...
	OPH_IMPORTNC6_operator_handle *oper_handle = (OPH_IMPORTNC6_operator_handle *) handle->operator_handle;
				...
				for (k = 0; k < frag_to_insert && res[l] == OPH_ANALYTICS_OPERATOR_SUCCESS; k++) {
					...
					new_frag.key_start =
					    (oper_handle->number_unven_frag - frag_already_inserted > 0 ? frag_already_inserted : oper_handle->number_unven_frag) 
					 	...
					 	(frag_already_inserted - oper_handle->number_unven_frag > 0 ? frag_already_inserted - oper_handle->number_unven_frag : 0) *
					    	actual_tuplexfrag_number + 1;
...
int task_destroy(oph_operator_struct * handle)
{
	...
	short int proc_error = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->execute_error;
	int id_datacube = ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_output_datacube;
	...
	if (handle->proc_rank == 0 && global_error == 0) {
		...
		if (oph_pid_get_uri(&tmp_uri)) {
			...
			logging(LOG_WARNING, __FILE__, __LINE__, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_PID_URI_ERROR);
			return OPH_ANALYTICS_OPERATOR_UTILITY_ERROR;
		}
		if (oph_pid_show_pid(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_input_container, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_output_datacube, tmp_uri)) {
			pmesg(LOG_ERROR, __FILE__, __LINE__, "Unable to print PID string\n");
			logging(LOG_WARNING, __FILE__, __LINE__, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_PID_SHOW_ERROR);
			free(tmp_uri);
			return OPH_ANALYTICS_OPERATOR_UTILITY_ERROR;
		}
		char jsonbuf[OPH_COMMON_BUFFER_LEN];
		memset(jsonbuf, 0, OPH_COMMON_BUFFER_LEN);
		snprintf(jsonbuf, OPH_COMMON_BUFFER_LEN, OPH_PID_FORMAT, tmp_uri, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_input_container, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_output_datacube);

		// ADD OUTPUT PID TO JSON AS TEXT
		if (oph_json_is_objkey_printable(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->objkeys, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->objkeys_num, OPH_JSON_OBJKEY_IMPORTNC)) {
	...
	if (global_error) {
		...
		if (handle->proc_rank == 0) {
			...
			if (oph_odb_cube_retrieve_datacube(oDB, id_datacube, &cube)) {
				...
				logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_DATACUBE_READ_ERROR);
			} else {
		...
		if (id_string[0] == 0) {
			pmesg(LOG_ERROR, __FILE__, __LINE__, "Master procedure or broadcasting has failed\n");
			logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_input_container, OPH_LOG_OPH_IMPORTNC_MASTER_TASK_INIT_FAILED);
		} else {
			if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragment_first_id >= 0 || handle->proc_rank == 0) {
				...
				if (oph_ids_get_substring_from_string
				    (id_string, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragment_first_id,
				     ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragment_number, &new_ptr)) {
					pmesg(LOG_ERROR, __FILE__, __LINE__, "Unable to split IDs fragment string\n");
					logging(LOG_ERROR, __FILE__, __LINE__, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_input_container,
						OPH_LOG_OPH_IMPORTNC_ID_STRING_SPLIT_ERROR);
				} else {
					//Delete fragments
					int start_position =
					    (int) floor((double) ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragment_first_id /
							((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragxdb_number);
					int row_number = (int)
					    ceil((double)
						 (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragment_first_id +
						  ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragment_number) /
						 ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->fragxdb_number) - start_position;

					if (oph_dproc_delete_data
					    (id_datacube, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_input_container, new_id_string, start_position, row_number)) {
		...
		if (handle->proc_rank == 0) {
			oph_dproc_clean_odb(&((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->oDB, id_datacube,
					    ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_input_container);
		}
	}
	return OPH_ANALYTICS_OPERATOR_SUCCESS;
}
...
int env_unset(oph_operator_struct * handle)
{
	...
	if (handle->proc_rank == 0) {
		oph_odb_free_ophidiadb(&((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->oDB);
	}
	if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->container_input) {
		free((char *) ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->container_input);
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->container_input = NULL;
	}
	if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->cwd) {
		free((char *) ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->cwd);
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->cwd = NULL;
	}

	if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->server)
		oph_dc_cleanup_dbms(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->server);


	if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->ioserver_type) {
		free((char *) ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->ioserver_type);
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->ioserver_type = NULL;
	}

	if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->user) {
		free((char *) ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->user);
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->user = NULL;
	}
	if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->grid_name) {
		free((char *) ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->grid_name);
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->grid_name = NULL;
	}
	if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nc_file_path) {
		free((char *) ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nc_file_path);
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nc_file_path = NULL;
	}
	if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nc_file_path_orig) {
		free((char *) ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nc_file_path_orig);
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->nc_file_path_orig = NULL;
	}
	if ((retval = nc_close(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->ncid)))
	...
	if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->partition_input) {
		free((char *) ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->partition_input);
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->partition_input = NULL;
	}
	if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_dimension_hierarchy) {
		free((int *) ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_dimension_hierarchy);
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->id_dimension_hierarchy = NULL;
	}
	if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->objkeys) {
		oph_tp_free_multiple_value_param_list(((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->objkeys, ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->objkeys_num);
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->objkeys = NULL;
	}
	if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->sessionid) {
		free((char *) ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->sessionid);
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->sessionid = NULL;
	}
	if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->base_time) {
		free((char *) ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->base_time);
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->base_time = NULL;
	}
	if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->units) {
		free((char *) ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->units);
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->units = NULL;
	}
	if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->calendar) {
		free((char *) ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->calendar);
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->calendar = NULL;
	}
	if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->month_lengths) {
		free((char *) ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->month_lengths);
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->month_lengths = NULL;
	}
	if (((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->description) {
		free((char *) ((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->description);
		((OPH_IMPORTNC6_operator_handle *) handle->operator_handle)->description = NULL;
	}

	free((OPH_IMPORTNC6_operator_handle *) handle->operator_handle);
