...
#define OPH_EXPORTESDM_OUTPUT_FILE "%s_%d"OPH_EXPORTESDM_OUTPUT_FILE_EXT
#define OPH_EXPORTESDM_OUTPUT_PATH "%s/"
#define OPH_EXPORTESDM_OUTPUT_PATH_SUMMARY OPH_EXPORTESDM_OUTPUT_PATH"%s.html"
