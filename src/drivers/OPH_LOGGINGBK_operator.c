...
int retrieve_logging_info(ophidiadb *oDB, OPH_LOGGINGBK_operator_handle *handle, unsigned long **field_lengths, int *num_fields, MYSQL_RES **logging_info)
{
    ...
    *field_lengths = NULL;
    ...
    if(handle->parent_job_id_filter) snprintf(parent_clause,OPH_COMMON_BUFFER_LEN,MYSQL_QUERY_OPH_LOGGINGBK_PARENT_ID, handle->parent_job_id_filter);
    ...
    switch (handle->session) {
        case 0:
            switch (handle->marker) {
                case 0:
                    snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_00000,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2, nlines);
                    break;
                case 1:
                            ...
                            switch (handle->mask[1]) {
                                case '0':
                                    switch (handle->mask[2]) {
                                        case '0':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_01000,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        case '1':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_01001,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        default:
                                ...
                                case '1':
                                    switch (handle->mask[2]) {
                                        case '0':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_01010,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        case '1':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_01011,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        default:
                                            pmesg(LOG_ERROR, __FILE__, __LINE__, "Invalid third mask value %c.\n",handle->mask[2]);
                                            return OPH_ANALYTICS_OPERATOR_BAD_PARAMETER;
                        ...
                        case '1':
                            switch (handle->mask[1]) {
                                case '0':
                                    switch (handle->mask[2]) {
                                        case '0':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_01100,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        case '1':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_01101,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        default:
                                            pmesg(LOG_ERROR, __FILE__, __LINE__, "Invalid third mask value %c.\n",handle->mask[2]);
                                            return OPH_ANALYTICS_OPERATOR_BAD_PARAMETER;
                                ...
                                case '1':
                                    switch (handle->mask[2]) {
                                        case '0':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_01110,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        case '1':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_01111,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        default:
                                            pmesg(LOG_ERROR, __FILE__, __LINE__, "Invalid third mask value %c.\n",handle->mask[2]);
                                            return OPH_ANALYTICS_OPERATOR_BAD_PARAMETER;
                        ...
                        case '0':
                            switch (handle->mask[1]) {
                                case '0':
                                    switch (handle->mask[2]) {
                                        case '0':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_02000,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        case '1':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_02001,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        default:
                                            pmesg(LOG_ERROR, __FILE__, __LINE__, "Invalid third mask value %c.\n",handle->mask[2]);
                                            return OPH_ANALYTICS_OPERATOR_BAD_PARAMETER;
                                ...
                                case '1':
                                    switch (handle->mask[2]) {
                                        case '0':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_02010,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        case '1':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_02011,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        default:
                                            pmesg(LOG_ERROR, __FILE__, __LINE__, "Invalid third mask value %c.\n",handle->mask[2]);
                                            return OPH_ANALYTICS_OPERATOR_BAD_PARAMETER;
                        ...
                        case '1':
                            switch (handle->mask[1]) {
                                case '0':
                                    switch (handle->mask[2]) {
                                        case '0':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_02100,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        case '1':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_02101,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        default:
                                            pmesg(LOG_ERROR, __FILE__, __LINE__, "Invalid third mask value %c.\n",handle->mask[2]);
                                            return OPH_ANALYTICS_OPERATOR_BAD_PARAMETER;
                                ...
                                case '1':
                                    switch (handle->mask[2]) {
                                        case '0':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_02110,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        case '1':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_02111,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        default:
                                            pmesg(LOG_ERROR, __FILE__, __LINE__, "Invalid third mask value %c.\n",handle->mask[2]);
                                            return OPH_ANALYTICS_OPERATOR_BAD_PARAMETER;
        ...
        case 1:
            switch (handle->marker) {
                case 0:
                    snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_10000,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2, nlines);
                    break;
                case 1:
                    switch (handle->mask[0]) {
                        case '0':
                            switch (handle->mask[1]) {
                                case '0':
                                    switch (handle->mask[2]) {
                                        case '0':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_11000,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        case '1':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_11001,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        default:
                                            pmesg(LOG_ERROR, __FILE__, __LINE__, "Invalid third mask value %c.\n",handle->mask[2]);
                                            return OPH_ANALYTICS_OPERATOR_BAD_PARAMETER;
                                ...
                                case '1':
                                    switch (handle->mask[2]) {
                                        case '0':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_11010,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        case '1':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_11011,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        default:
                                            pmesg(LOG_ERROR, __FILE__, __LINE__, "Invalid third mask value %c.\n",handle->mask[2]);
                                            return OPH_ANALYTICS_OPERATOR_BAD_PARAMETER;
                        ...
                        case '1':
                            switch (handle->mask[1]) {
                                case '0':
                                    switch (handle->mask[2]) {
                                        case '0':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_11100,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        case '1':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_11101,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        default:
                                            pmesg(LOG_ERROR, __FILE__, __LINE__, "Invalid third mask value %c.\n",handle->mask[2]);
                                            return OPH_ANALYTICS_OPERATOR_BAD_PARAMETER;
                                ...
                                case '1':
                                    switch (handle->mask[2]) {
                                        case '0':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_11110,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        case '1':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_11111,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        default:
                                            pmesg(LOG_ERROR, __FILE__, __LINE__, "Invalid third mask value %c.\n",handle->mask[2]);
                                            return OPH_ANALYTICS_OPERATOR_BAD_PARAMETER;
                        ...
                        case '0':
                            switch (handle->mask[1]) {
                                case '0':
                                    switch (handle->mask[2]) {
                                        case '0':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_12000,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        case '1':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_12001,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        default:
                                            pmesg(LOG_ERROR, __FILE__, __LINE__, "Invalid third mask value %c.\n",handle->mask[2]);
                                            return OPH_ANALYTICS_OPERATOR_BAD_PARAMETER;
                                ...
                                case '1':
                                    switch (handle->mask[2]) {
                                        case '0':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_12010,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        case '1':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_12011,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        default:
                                            pmesg(LOG_ERROR, __FILE__, __LINE__, "Invalid third mask value %c.\n",handle->mask[2]);
                                            return OPH_ANALYTICS_OPERATOR_BAD_PARAMETER;
                        ...
                        case '1':
                            switch (handle->mask[1]) {
                                case '0':
                                    switch (handle->mask[2]) {
                                        case '0':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_12100,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        case '1':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_12101,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        default:
                                            pmesg(LOG_ERROR, __FILE__, __LINE__, "Invalid third mask value %c.\n",handle->mask[2]);
                                            return OPH_ANALYTICS_OPERATOR_BAD_PARAMETER;
                                ...
                                case '1':
                                    switch (handle->mask[2]) {
                                        case '0':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_12110,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        case '1':
                                            snprintf(query,MYSQL_BUFLEN,MYSQL_QUERY_OPH_LOGGINGBK_12111,handle->user,handle->session_filter,handle->session_label_filter,handle->session_creation_date1,handle->session_creation_date2,handle->workflow_id_filter,handle->marker_id_filter,handle->job_submission_date1,handle->job_submission_date2,handle->job_status,handle->submission_string_filter,handle->job_start_date1,handle->job_start_date2,handle->job_end_date1,handle->job_end_date2, (handle->parent_job_id_filter ? parent_clause : "" ), nlines);
                                            break;
                                        default:
                                            pmesg(LOG_ERROR, __FILE__, __LINE__, "Invalid third mask value %c.\n",handle->mask[2]);
                                            return OPH_ANALYTICS_OPERATOR_BAD_PARAMETER;
...
int task_execute(oph_operator_struct *handle)
{
  ...
  row_separator[count++] = '+';
  for (i = 0; i < num_fields; i++) {
      if(!strncmp(fields[i].name,OPH_LOGGINGBK_SUBMISSION_STRING,strlen(OPH_LOGGINGBK_SUBMISSION_STRING))) continue;
      row_separator[count++] = '-';
      len = (field_lengths[i] > fields[i].name_length)?field_lengths[i]:fields[i].name_length;
      if(submission_string_flag && (total_len < OPH_LOGGINGBK_MIN_WIDTH) ){
      ...
      row_separator[count++] = '-';
      if(!strncmp(fields[i].name,OPH_LOGGINGBK_JOB_ID,strlen(OPH_LOGGINGBK_JOB_ID))) row_separator[count++] = '-';
      else row_separator[count++] = '+';
  }
  ...
  if (oph_json_is_objkey_printable(((OPH_LOGGINGBK_operator_handle*)handle->operator_handle)->objkeys,((OPH_LOGGINGBK_operator_handle*)handle->operator_handle)->objkeys_num,OPH_JSON_OBJKEY_LOGGINGBK)) {
  ...
  for (i = 0; i < num_fields; i++) {
	  ...
	  if (oph_json_is_objkey_printable(((OPH_LOGGINGBK_operator_handle*)handle->operator_handle)->objkeys,((OPH_LOGGINGBK_operator_handle*)handle->operator_handle)->objkeys_num,OPH_JSON_OBJKEY_LOGGINGBK)) {
		  if (keys) keys[i] = strdup(fields[i].name);
		  if (fieldtypes) {
			  if (!strcmp(fields[i].name,OPH_LOGGINGBK_JOB_ID) || !strcmp(fields[i].name,OPH_LOGGINGBK_MARKER_ID) || !strcmp(fields[i].name,OPH_LOGGINGBK_PARENT_JOB_ID) || !strcmp(fields[i].name,OPH_LOGGINGBK_WORKFLOW_ID))
      ...
      if(!strncmp(fields[i].name,OPH_LOGGINGBK_SUBMISSION_STRING,strlen(OPH_LOGGINGBK_SUBMISSION_STRING))) continue;
      if(!strncmp(fields[i].name,OPH_LOGGINGBK_PARENT_JOB_ID,strlen(OPH_LOGGINGBK_PARENT_JOB_ID))) continue;
      ...
      else printf(" %-*s |",field_new_len[i],fields[i].name);
  }
  printf("\n%s\n",row_separator);
  ...
  while((row = mysql_fetch_row(logging_info))){
	  ...
	  if (oph_json_is_objkey_printable(((OPH_LOGGINGBK_operator_handle*)handle->operator_handle)->objkeys,((OPH_LOGGINGBK_operator_handle*)handle->operator_handle)->objkeys_num,OPH_JSON_OBJKEY_LOGGINGBK)) {
		  for (i = 0; i < num_fields; i++) {
			  if (row[i]) my_row[i] = strdup(row[i]);
			  else my_row[i] = strdup("");
			  if (!my_row[i]) {
				  pmesg(LOG_ERROR, __FILE__, __LINE__, "Error allocating memory\n");
				  logging(LOG_ERROR, __FILE__, __LINE__, OPH_GENERIC_CONTAINER_ID, "Error allocating memory\n");
				  free(tmp_buffer);
	  ...
	  if (oph_json_is_objkey_printable(((OPH_LOGGINGBK_operator_handle*)handle->operator_handle)->objkeys,((OPH_LOGGINGBK_operator_handle*)handle->operator_handle)->objkeys_num,OPH_JSON_OBJKEY_LOGGINGBK)) {
		  if (oph_json_add_grid_row(handle->operator_json,OPH_JSON_OBJKEY_LOGGINGBK,my_row)) {
			  ...
			  int j;
			  for (j = 0; j < num_fields; j++) free(my_row[j]);
			  free(my_row);
			  return OPH_ANALYTICS_OPERATOR_UTILITY_ERROR;
		  }
	  }
	  ...
	  //FREE JSON VALUES START
	  if (oph_json_is_objkey_printable(((OPH_LOGGINGBK_operator_handle*)handle->operator_handle)->objkeys,((OPH_LOGGINGBK_operator_handle*)handle->operator_handle)->objkeys_num,OPH_JSON_OBJKEY_LOGGINGBK)) {
		  for (i = 0; i < num_fields; i++) free(my_row[i]);
	  }
	  //FREE JSON VALUES END
      ...
      for (i = 0; i < num_fields; i++) {
          if(!strncmp(fields[i].name,OPH_LOGGINGBK_SUBMISSION_STRING,strlen(OPH_LOGGINGBK_SUBMISSION_STRING))){
              ...
              if(!i) printf("|");
              if(!strncmp(fields[i].name,OPH_LOGGINGBK_JOB_ID,strlen(OPH_LOGGINGBK_JOB_ID)) && !strncmp(fields[i+1].name,OPH_LOGGINGBK_PARENT_JOB_ID,strlen(OPH_LOGGINGBK_PARENT_JOB_ID))){
                    if(row[i+1]) snprintf(tmp_header, OPH_COMMON_BUFFER_LEN, "%s (%s)", row[i] ? row[i] : "-", row[i+1]);
                    else snprintf(tmp_header, OPH_COMMON_BUFFER_LEN, "%s", row[i] ? row[i] : "-");
                    printf(" %-*s |",field_new_len[i] + field_new_len[i+1] + 3, tmp_header);
              }
              else printf(" %-*s |",field_new_len[i],row[i]?row[i]:"-");
