...
/**
 * \brief Structure of parameters needed by the operator OPH_IMPORTNC3. It creates a new datacube filling it with data taken from nc file
 *
 ...
 * \param fits_file_path Path of the nc file to import
...
/* For fits files variables related to time management could be unuseful */
  char* base_time;
  char* units;
  char* calendar;
  char* month_lengths;
